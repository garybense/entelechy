//! API client wrapper
//!
//! This module provides a thin wrapper around the auto-generated entelechy-client
//! to bridge from the CLI's synchronous code to the async API client.

use anyhow::Result;
pub use entelechy_client::types;
use entelechy_client::{Client as AsyncClient, Error as ClientError};
...
// OpenAPI coverage. Enforced by `uv run cli-coverage-check` in entelechy-dev.
// ============================================================================
