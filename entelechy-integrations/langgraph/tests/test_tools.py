"""Unit tests for Entelechy LangGraph tools."""

from unittest.mock import AsyncMock, MagicMock, patch

import pytest
from entelechy_langgraph import (
    configure,
    create_entelechy_tools,
    reset_config,
)
from entelechy_langgraph.errors import EntelechyError
...
class TestCreateEntelechyTools:
    ...
    def test_falls_back_to_global_config(self):
        ...
        with patch("entelechy_langgraph._client.Entelechy") as mock_cls:
