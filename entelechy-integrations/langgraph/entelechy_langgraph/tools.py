"""LangGraph tool definitions for Entelechy memory operations.

Provides factory functions that create LangGraph-compatible tool functions
backed by Entelechy's retain/recall/reflect APIs. These tools can be bound
...
def create_entelechy_tools(
    *,
    ...
    """Create Entelechy memory tools for a LangGraph agent.
