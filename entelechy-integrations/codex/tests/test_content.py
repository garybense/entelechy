...
class TestComposeRecallQuery:
    ...
    def test_strips_memory_tags_from_context(self):
        msgs = _msgs(("user", "<entelechy_memories>secret</entelechy_memories> actual question"))
...
class TestPrepareRetentionTranscriptJson:
    ...
    def test_json_format_strips_memory_tags(self):
        msgs = [
            {
                "role": "user",
                "content": [
                    {"type": "text", "text": "<entelechy_memories>secret</entelechy_memories> real question"},
                ],
            },
        ]
        ...
        assert "entelechy_memories" not in transcript
