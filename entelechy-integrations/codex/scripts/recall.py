...
Fires before each user prompt. Retrieves relevant memories from Entelechy
...
def main():
    ...
    try:
        ...
        print(f"[Entelechy] Recall failed: {e}", file=sys.stderr)
        return
...
if __name__ == "__main__":
    try:
        ...
        print(f"[Entelechy] Unexpected error in recall: {e}", file=sys.stderr)
        try:
