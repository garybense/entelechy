"""Unit tests for Entelechy LlamaIndex memory."""
...
class TestEntelechyMemoryCreation:
    ...
    def test_from_url(self):
        with patch("entelechy_llamaindex.memory.Entelechy") as mock_cls:
            mock_cls.return_value = _mock_client()
            memory = EntelechyMemory.from_url(
    ...
    def test_from_defaults_raises(self):
        with pytest.raises(NotImplementedError):
            EntelechyMemory.from_defaults()

    def test_class_name(self):
        assert EntelechyMemory.class_name() == "EntelechyMemory"


class TestPut:
    def test_put_user_message_retains(self):
        client = _mock_client()
        memory = EntelechyMemory.from_client(client=client, bank_id="test")
