"""Unit tests for entelechy_agno configuration."""

import os
from unittest.mock import patch

from entelechy_agno import configure, get_config, reset_config
from entelechy_agno.config import (
...
class TestEntelechyAgnoConfigDataclass:
...
class TestConfigure:
    ...
    def test_configure_returns_config_instance(self):
        config = configure()
        assert isinstance(config, EntelechyAgnoConfig)
