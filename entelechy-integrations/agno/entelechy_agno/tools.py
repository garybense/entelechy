"""Agno Toolkit for Entelechy memory operations.
...
try:
    _VERSION = metadata.version("entelechy-agno")
except metadata.PackageNotFoundError:
    _VERSION = "0.0.0"
_USER_AGENT = f"entelechy-agno/{_VERSION}"

_TOOL_INSTRUCTIONS = """\
You have access to long-term memory via Entelechy tools.
...
class EntelechyTools(Toolkit):
    """Agno Toolkit providing Entelechy memory tools.
