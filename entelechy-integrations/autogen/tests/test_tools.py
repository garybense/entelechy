"""Unit tests for Entelechy AutoGen tools."""

from unittest.mock import AsyncMock, MagicMock, patch

import pytest
from autogen_core import CancellationToken
from entelechy_autogen import (
    configure,
...
def _mock_client():
    """Create a mock Entelechy client with async methods."""
    client = MagicMock()
...
class TestCreateEntelechyTools:
    ...
    def test_falls_back_to_global_config(self):
        ...
        with patch("entelechy_autogen._client.Entelechy") as mock_cls:
    ...
    def test_explicit_url_overrides_config(self):
        ...
        with patch("entelechy_autogen._client.Entelechy") as mock_cls:
            mock_cls.return_value = _mock_client()
            create_entelechy_tools(bank_id="test", entelechy_api_url="http://explicit:9999")
...
class TestRetainTool:
    ...
    @pytest.mark.asyncio
    async def test_retain_raises_entelechy_error(self):
        client = _mock_client()
...
class TestRecallTool:
    ...
    @pytest.mark.asyncio
    async def test_recall_raises_entelechy_error(self):
        client = _mock_client()
...
class TestReflectTool:
    ...
    @pytest.mark.asyncio
    async def test_reflect_raises_entelechy_error(self):
        client = _mock_client()
