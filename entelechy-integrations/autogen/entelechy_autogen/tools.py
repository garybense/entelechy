"""AutoGen tool definitions for Entelechy memory operations.

Provides a factory function that creates AutoGen-compatible ``FunctionTool``
instances backed by Entelechy's retain/recall/reflect APIs. These tools can
...
def create_entelechy_tools(
    *,
    ...
    """Create Entelechy memory tools for an AutoGen agent.
