"""Entelechy-Pipecat: Persistent memory for voice AI pipelines.

Provides a Entelechy-backed FrameProcessor for Pipecat pipelines,
...
from .memory import EntelechyMemoryService
