...
Persistent memory for AI agent crews via Entelechy. Give your CrewAI crews long-term memory with fact extraction, entity tracking, and temporal awareness.
...
# Step 2: Create crew with Entelechy-backed memory
crew = Crew(
    agents=[
...
configure(
    entelechy_api_url="http://localhost:8888",  # Default: production API
