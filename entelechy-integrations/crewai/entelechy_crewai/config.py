"""Global configuration for Entelechy-CrewAI integration."""
...
_global_config: EntelechyCrewAIConfig | None = None
...
def configure(
    ...
    Returns:
        The configured EntelechyCrewAIConfig.
    """
    ...
    _global_config = EntelechyCrewAIConfig(
...
def get_config() -> EntelechyCrewAIConfig | None:
