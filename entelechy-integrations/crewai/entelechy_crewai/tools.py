"""CrewAI Tool for Entelechy reflect operations.
...
class EntelechyReflectTool(BaseTool):
    ...
    Args:
        bank_id: The Entelechy memory bank to reflect against.
    ...
    entelechy_api_url: str | None = Field(default=None, description="Override API URL")
    ...
    def _get_client(self) -> Any:
        ...
        if client is None:
            ...
            config = get_config()
            api_url = self.entelechy_api_url or (config.entelechy_api_url if config else "http://localhost:8888")
    ...
    def _run(self, query: str) -> str:
        ...
        Raises:
            EntelechyError: If the reflect operation fails.
        """
