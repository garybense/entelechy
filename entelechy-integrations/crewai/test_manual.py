"""Manual integration test for entelechy-crewai.

Prerequisites:
  1. Entelechy API running on localhost:8888 (./scripts/dev/start-api.sh)
...
from entelechy_crewai import EntelechyReflectTool, EntelechyStorage, configure
...
configure(entelechy_api_url=ENTELECHY_URL, verbose=True)
...
reflect_tool = EntelechyReflectTool(bank_id=BANK_ID, budget="mid")
...
recall_task = Task(
    description=(
        ...
        "Use the entelechy_reflect tool to check your memories."
    ),
