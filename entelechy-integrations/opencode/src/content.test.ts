...
describe("stripMemoryTags", () => {
  it("removes <entelechy_memories> blocks", () => {
    const input = "before <entelechy_memories>secret</entelechy_memories> after";
  ...
  it("removes multiple blocks", () => {
    const input =
      "<entelechy_memories>a</entelechy_memories> middle <relevant_memories>b</relevant_memories>";
...
describe("prepareRetentionTranscript", () => {
  ...
  it("strips memory tags from content", () => {
    const msgs = [
      { role: "user", content: "Query <entelechy_memories>data</entelechy_memories>" },
      { role: "assistant", content: "Response" },
    ];
    const { transcript } = prepareRetentionTranscript(msgs);
    expect(transcript).not.toContain("entelechy_memories");
    expect(transcript).toContain("Query");
  });

  it("skips messages with empty content after stripping", () => {
    const msgs = [
      { role: "user", content: "<entelechy_memories>only tags</entelechy_memories>" },
      { role: "assistant", content: "Response" },
    ];
