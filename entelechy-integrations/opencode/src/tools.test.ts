...
describe("createTools", () => {
  it("creates all three tools", () => {
    ...
    expect(tools.entelechy_retain).toBeDefined();
    expect(tools.entelechy_recall).toBeDefined();
    expect(tools.entelechy_reflect).toBeDefined();
  });
  ...
  describe("entelechy_retain", () => {
    it("calls client.retain with correct bank and content", async () => {
      ...
      const result = await tools.entelechy_retain.execute(
    ...
    it("passes optional context", async () => {
      ...
      await tools.entelechy_retain.execute(
    ...
    it("includes tags and metadata from config", async () => {
      ...
      await tools.entelechy_retain.execute({ content: "Fact" }, mockContext);
  ...
  describe("entelechy_recall", () => {
    it("calls client.recall and formats results", async () => {
      ...
      const result = await tools.entelechy_recall.execute(
    ...
    it("returns no-results message when empty", async () => {
      ...
      const result = await tools.entelechy_recall.execute({ query: "unknown" }, mockContext);
    ...
    it("uses config budget settings", async () => {
      ...
      await tools.entelechy_recall.execute({ query: "test" }, mockContext);
  ...
  describe("entelechy_reflect", () => {
    it("calls client.reflect and returns text", async () => {
      ...
      const result = await tools.entelechy_reflect.execute(
    ...
    it("returns fallback when no text", async () => {
      ...
      const result = await tools.entelechy_reflect.execute({ query: "something" }, mockContext);
    ...
    it("passes context to reflect", async () => {
      ...
      await tools.entelechy_reflect.execute(
  ...
  describe("error propagation", () => {
    it("propagates retain errors", async () => {
      ...
      await expect(
        tools.entelechy_retain.execute({ content: "test" }, mockContext)
    ...
    it("propagates recall errors", async () => {
      ...
      await expect(tools.entelechy_recall.execute({ query: "test" }, mockContext)).rejects.toThrow(
        "Timeout"
      );
    });
    ...
    it("propagates reflect errors", async () => {
      ...
      await expect(tools.entelechy_reflect.execute({ query: "test" }, mockContext)).rejects.toThrow(
        "Server error"
      );
    });
  });
  ...
  describe("bank mission setup", () => {
    ...
    it("calls ensureBankMission before reflect when missionsSet provided", async () => {
      ...
      await tools.entelechy_reflect.execute({ query: "summary" }, mockContext);
  ...
  it("always uses constructor bankId", async () => {
    ...
    await tools.entelechy_retain.execute({ content: "x" }, mockContext);
    await tools.entelechy_recall.execute({ query: "x" }, mockContext);
    await tools.entelechy_reflect.execute({ query: "x" }, mockContext);
