"""OpenAI Agents SDK tool definitions for Entelechy memory operations.

Provides factory functions that create OpenAI Agents SDK-compatible
``FunctionTool`` instances and dynamic instructions backed by Entelechy's
...
def create_entelechy_tools(
    *,
    ...
    """Create Entelechy memory tools for an OpenAI Agents SDK agent.
...
def memory_instructions(
    *,
    ...
    automatically recalls relevant memories from Entelechy and appends
    ...
    Example::
        ...
        from entelechy_openai_agents import memory_instructions, create_entelechy_tools
