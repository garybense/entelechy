"""Global configuration for Entelechy-OpenAI-Agents integration."""
...
@dataclass
class EntelechyOpenAIAgentsConfig:
...
_global_config: EntelechyOpenAIAgentsConfig | None = None
...
def configure(
    ...
    Returns:
        The configured EntelechyOpenAIAgentsConfig.
    """
    ...
    _global_config = EntelechyOpenAIAgentsConfig(
...
def get_config() -> EntelechyOpenAIAgentsConfig | None:
