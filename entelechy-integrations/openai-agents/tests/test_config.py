"""Unit tests for entelechy_openai_agents configuration."""

import os
from unittest.mock import patch

from entelechy_openai_agents import configure, get_config, reset_config
from entelechy_openai_agents.config import (
    DEFAULT_BUDGET,
