...
|------|-----------|-------------|
| `entelechy_retain` | Retain | Store facts, preferences, decisions to long-term memory |
| `entelechy_recall` | Recall | Multi-strategy search across stored memories |
| `entelechy_reflect` | Reflect | Synthesize reasoned answers from memories |
...
All global settings can be overridden per `create_entelechy_tools()` call:

| Parameter | Description | Default |
|-----------|-------------|---------|
| `bank_id` | Memory bank ID (required) | — |
| `client` | Pre-configured `Entelechy` client | — |
| `entelechy_api_url` | API URL | Global config or production |
...
- [Entelechy Documentation](https://entelechy.docs.vectorize.io)
- [AG2 Documentation](https://docs.ag2.ai)
- [API Reference](https://entelechy.docs.vectorize.io/api)
