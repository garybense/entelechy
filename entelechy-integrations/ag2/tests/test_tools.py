"""Unit tests for Entelechy AG2 tools."""
...
import pytest
from entelechy_ag2 import (
    configure,
    create_entelechy_tools,
    register_entelechy_tools,
    reset_config,
)
from entelechy_ag2.errors import EntelechyError


def _mock_client():
    """Create a mock Entelechy client with sync methods."""
    client = MagicMock()
...
class TestImports:
    def test_imports(self):
        from entelechy_ag2 import (  # noqa: F401
            EntelechyAG2Config,
            EntelechyError,
            configure,
            create_entelechy_tools,
...
class TestCreateEntelechyTools:
    ...
    def test_falls_back_to_global_config(self):
        ...
        with patch("entelechy_ag2._client.Entelechy") as mock_cls:
    ...
    def test_explicit_url_overrides_config(self):
        ...
        with patch("entelechy_ag2._client.Entelechy") as mock_cls:
            mock_cls.return_value = _mock_client()
            create_entelechy_tools(
                bank_id="test", entelechy_api_url="http://explicit:9999"
            )
            mock_cls.assert_called_once()
...
class TestRegisterEntelechyTools:
    def test_registers_all_tools(self):
        ...
        tools = register_entelechy_tools(
    ...
    def test_registers_with_docstring_descriptions(self):
        ...
        register_entelechy_tools(agent, executor, bank_id="test", client=client)
