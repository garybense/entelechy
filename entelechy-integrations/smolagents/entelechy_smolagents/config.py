"""Global configuration for Entelechy-SmolAgents integration."""
...
@dataclass
class EntelechySmolAgentsConfig:
...
_global_config: EntelechySmolAgentsConfig | None = None
...
def configure(
    ...
    Returns:
        The configured EntelechySmolAgentsConfig.
    """
    ...
    _global_config = EntelechySmolAgentsConfig(
...
def get_config() -> EntelechySmolAgentsConfig | None:
