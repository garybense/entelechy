"""Configuration management for Entelechy plugin.
...
def load_config() -> dict:
    ...
    Loading order (later entries win):
      ...
      3. User config                   (~/.entelechy/claude-code.json)
      4. Environment variable overrides

    ~/.entelechy/claude-code.json is the recommended place to configure the
    ...
    user_config_path = os.path.join(os.path.expanduser("~"), ".entelechy", "claude-code.json")
