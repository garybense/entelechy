...
const manifest: PaperclipPluginManifestV1 = {
  ...
  instanceConfigSchema: {
    type: "object",
    required: ["entelechyApiUrl"],
    properties: {
      entelechyApiUrl: {
        type: "string",
        title: "Entelechy API URL",
        description:
          "Base URL of your Entelechy instance. Use http://localhost:8888 for self-hosted.",
        default: "http://localhost:8888",
      },
      entelechyApiKeyRef: {
        type: "string",
        title: "Entelechy API Key (secret ref)",
        description:
          "Name of the Paperclip secret holding your Entelechy Cloud API key. Leave empty for self-hosted.",
      },
      bankGranularity: {
        type: "array",
      ...
      autoRetain: {
        ...
        description: "Automatically retain agent run output to Entelechy when a run completes.",
        default: true,
      },
    },
  },
  tools: [
    {
      ...
      description:
        "Search Entelechy long-term memory for context relevant to a query. Use this before starting a task to surface relevant past decisions, preferences, and knowledge.",
      parametersSchema: {
        type: "object",
        required: ["query"],
        properties: {
