"""Global configuration for Entelechy-Strands integration."""
...
_global_config: EntelechyStrandsConfig | None = None
...
def configure(
    ...
    Returns:
        The configured EntelechyStrandsConfig.
    """
    ...
    _global_config = EntelechyStrandsConfig(
...
def get_config() -> EntelechyStrandsConfig | None:
