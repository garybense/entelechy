"""Unit tests for entelechy_strands configuration."""

import os
from unittest.mock import patch

from entelechy_strands import configure, get_config, reset_config
from entelechy_strands.config import (
...
class TestEntelechyStrandsConfigDataclass:
    def test_default_values(self):
        config = EntelechyStrandsConfig()
...
class TestConfigure:
    ...
    def test_configure_returns_config_instance(self):
        config = configure()
        assert isinstance(config, EntelechyStrandsConfig)
