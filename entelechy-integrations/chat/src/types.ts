...
/**
 * Configuration for withEntelechyChat.
 */
export interface EntelechyChatOptions {
 ...
 */
export interface EntelechyChatContext {
...
/**
 * The handler signature that withEntelechyChat wraps.
 */
export type EntelechyChatHandler<TState = unknown> = (
  thread: ChatThread<TState>,
  message: ChatMessage,
  ctx: EntelechyChatContext
) => void | Promise<void>;
