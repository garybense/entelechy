"""Global configuration for Entelechy-Pydantic AI integration."""
...
@dataclass
class EntelechyPydanticAIConfig:
...
_global_config: EntelechyPydanticAIConfig | None = None
...
def configure(
    ...
    Returns:
        The configured EntelechyPydanticAIConfig.
    """
    ...
    _global_config = EntelechyPydanticAIConfig(
...
def get_config() -> EntelechyPydanticAIConfig | None:
