"""Unit tests for Entelechy Pydantic AI tools."""

from unittest.mock import AsyncMock, MagicMock, patch

import pytest

from entelechy_pydantic_ai import (
    configure,
    create_entelechy_tools,
    memory_instructions,
    reset_config,
)
from entelechy_pydantic_ai.errors import EntelechyError
...
class TestCreateEntelechyTools:
    ...
    def test_falls_back_to_global_config(self):
        ...
        with patch("entelechy_pydantic_ai.tools.Entelechy") as mock_cls:
