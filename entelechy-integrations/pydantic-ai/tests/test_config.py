"""Unit tests for entelechy_pydantic_ai configuration."""

import os
from unittest.mock import patch

from entelechy_pydantic_ai import configure, get_config, reset_config
from entelechy_pydantic_ai.config import (
