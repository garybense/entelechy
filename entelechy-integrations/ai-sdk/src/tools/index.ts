...
/**
 * Recall result item from Entelechy
 */
...
/**
 * Recall response from Entelechy
 */
...
/**
 * Nested based_on structure from Entelechy reflect
 */
...
/**
 * Reflect response from Entelechy
 */
...
/**
 * Retain response from Entelechy
 */
...
/**
 * Mental model response from Entelechy
 */
...
/**
 * Document response from Entelechy
 */
...
export interface EntelechyToolsOptions {
  /** Entelechy client instance */
...
/**
 * Creates AI SDK tools for Entelechy memory operations.
 *
 ...
 * @example
 * ```ts
 * const tools = createEntelechyTools({
 *   client: entelechyClient,
 *   bankId: userId,
 ...
 * ```
 */
export function createEntelechyTools({
  client,
  bankId,
  retain: retainOpts = {},
  recall: recallOpts = {},
...
export type EntelechyTools = ReturnType<typeof createEntelechyTools>;
