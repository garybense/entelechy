"""
Tests for Entelechy Python client.
...
@pytest.fixture
def client():
    """Create a Entelechy client for testing."""
    with Entelechy(base_url=ENTELECHY_API_URL) as client:
        yield client
...
class TestBankStats:
    ...
    async def test_get_bank_stats(self, client, bank_id):
        ...
        from entelechy_client_api.api import BanksApi

        config = Configuration(host=ENTELECHY_API_URL)
...
class TestOperations:
    ...
    async def test_list_operations(self, client, bank_id):
        ...
        from entelechy_client_api import ApiClient, Configuration
        from entelechy_client_api.api import OperationsApi
...
class TestEntities:
    ...
    def test_list_entities(self, client, bank_id):
        ...
        from entelechy_client_api import ApiClient, Configuration
        from entelechy_client_api.api import EntitiesApi
