"""
Entelechy Client - Clean, pythonic wrapper for the Entelechy API.

This package provides a high-level ``Entelechy`` class with simplified methods
...
clients exposed as properties on the ``Entelechy`` instance (e.g.
...
from entelechy_client_api.models.recall_response import RecallResponse as _RecallResponse
from entelechy_client_api.models.recall_result import RecallResult as _RecallResult
...
def _recall_response_to_prompt_string(self) -> str:
    ...
    This mirrors the format used internally by Entelechy's reflect operation.
    """
    import json
