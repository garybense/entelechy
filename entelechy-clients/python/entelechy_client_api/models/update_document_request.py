...
class UpdateDocumentRequest(BaseModel):
    ...
    """ # noqa: E501
    tags: Optional[List[StrictStr]] = Field(default=None, description="New tags for the document and its memory units. Triggers observation invalidation and re-consolidation.")
