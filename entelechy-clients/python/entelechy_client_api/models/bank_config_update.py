...
class BankConfigUpdate(BaseModel):
    ...
    """ # noqa: E501
    updates: Dict[str, Any] = Field(description="Configuration overrides. Keys can be in Python field format (llm_provider) or environment variable format (ENTELECHY_API_LLM_PROVIDER). Only hierarchical fields can be overridden per-bank.")
