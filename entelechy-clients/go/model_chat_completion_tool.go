...
func NewChatCompletionTool(type_ string, function ChatCompletionToolFunction) *ChatCompletionTool {
...
func (o *ChatCompletionTool) GetFunction() ChatCompletionToolFunction {
	if o == nil {
		var ret ChatCompletionToolFunction
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ChatCompletionTool) GetFunctionOk() (*ChatCompletionToolFunction, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ChatCompletionTool) SetFunction(v ChatCompletionToolFunction) {
	o.Function = v
}
