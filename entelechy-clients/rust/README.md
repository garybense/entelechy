# Entelechy Rust Client

Auto-generated Rust client library for the Entelechy semantic memory system API.
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // Search memories
    let search_request = entelechy_client::types::SearchRequest {
    ...
    // Store a memory
    let memory_request = entelechy_client::types::BatchMemoryRequest {
        items: vec![
            entelechy_client::types::MemoryItem {
...
└── target/
    └── debug/build/
        └── entelechy-client-.../out/
            └── entelechy_client_generated.rs  # Generated code
```
