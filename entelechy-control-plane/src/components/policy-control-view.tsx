      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-muted-foreground">
            Monitors and enforces the stability of the policy vector over time. Rejects policy
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Determines if the proposed policy vector is allowed to be injected.
            </CardDescription>
          </CardHeader>
            ...
            {isAdmissible ? (
              <>
                ...
                <p className="text-sm text-muted-foreground text-center mt-2">
                  Drift is within acceptable parameters. Policy update approved.
                </p>
              </>
            ) : (
              <>
                ...
                <p className="text-sm text-muted-foreground text-center mt-2">
                  Policy change exceeds $\epsilon$-limit. Enforcing inertia; previous policy
                  retained.
                </p>
              </>
            )}
      ...
      <Card>
        ...
        <CardContent>
          <ul className="list-disc pl-5 space-y-2 text-sm text-muted-foreground">
            <li>
              <strong>Objective:</strong> Prevent rapid, unpredictable changes in agent personality
              or methodology (Drift Collapse).
            </li>
            <li>
