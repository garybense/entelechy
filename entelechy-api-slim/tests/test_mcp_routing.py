...
async def test_mcp_context_variable():
    ...
    from entelechy_api.api.mcp import _current_bank_id, get_current_bank_id
...
async def test_mcp_tools_use_context_bank_id(mock_memory):
    ...
    from entelechy_api.api.mcp import _current_bank_id, create_mcp_server
...
async def test_api_key_context_variable():
    ...
    from entelechy_api.api.mcp import _current_api_key, get_current_api_key
...
async def test_mcp_tools_propagate_api_key(mock_memory):
    ...
    from entelechy_api.api.mcp import _current_api_key, _current_bank_id, create_mcp_server
...
async def test_tenant_id_context_variable():
    ...
    from entelechy_api.api.mcp import (
        _current_api_key_id,
        _current_tenant_id,
...
async def test_middleware_handles_both_endpoints(mock_memory):
    ...
    from entelechy_api.api.mcp import MCPMiddleware
...
def test_global_mcp_enabled_tools_filter_restricts_registered_tools(mock_memory):
    ...
    with patch("entelechy_api.api.mcp._get_raw_config", return_value=mock_cfg):
        mcp_server = create_mcp_server(mock_memory, multi_bank=True)
