...
from entelechy_api.engine.embeddings import LiteLLMSDKEmbeddings, create_embeddings_from_env
...
class TestLiteLLMSDKEmbeddingsFactory:
    ...
    def test_create_from_env_success(self, monkeypatch):
        ...
        # Mock get_config() to return configured EntelechyConfig
        ...
        with patch("entelechy_api.config.get_config", return_value=mock_config):
