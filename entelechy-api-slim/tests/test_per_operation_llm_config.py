...
def setup_test_env():
    ...
    env_vars_to_set = {
        "ENTELECHY_API_SKIP_LLM_VERIFICATION": "true",
        "ENTELECHY_API_LAZY_RERANKER": "true",
        "ENTELECHY_API_LLM_PROVIDER": "mock",
        "ENTELECHY_API_LLM_MODEL": "default-model",
        "ENTELECHY_API_RETAIN_LLM_PROVIDER": "mock",
        "ENTELECHY_API_RETAIN_LLM_MODEL": "retain-model",
        "ENTELECHY_API_REFLECT_LLM_PROVIDER": "mock",
        "ENTELECHY_API_REFLECT_LLM_MODEL": "reflect-model",
    }
...
class TestPerOperationLLMConfig:
    ...
    def test_memory_engine_fallback_when_no_per_operation_config(self):
        ...
        from entelechy_api.config import clear_config_cache as clear_cache

        # Temporarily clear per-operation env vars
        retain_provider = os.environ.pop("ENTELECHY_API_RETAIN_LLM_PROVIDER", None)
        retain_model = os.environ.pop("ENTELECHY_API_RETAIN_LLM_MODEL", None)
        reflect_provider = os.environ.pop("ENTELECHY_API_REFLECT_LLM_PROVIDER", None)
        reflect_model = os.environ.pop("ENTELECHY_API_REFLECT_LLM_MODEL", None)
        ...
        try:
            ...
            # Restore env vars
            if retain_provider:
                os.environ["ENTELECHY_API_RETAIN_LLM_PROVIDER"] = retain_provider
            if retain_model:
                os.environ["ENTELECHY_API_RETAIN_LLM_MODEL"] = retain_model
            if reflect_provider:
                os.environ["ENTELECHY_API_REFLECT_LLM_PROVIDER"] = reflect_provider
            if reflect_model:
                os.environ["ENTELECHY_API_REFLECT_LLM_MODEL"] = reflect_model
            clear_cache()
...
class TestReflectUsesReflectLLMConfig:
    ...
    async def test_reflect_allowed_when_default_llm_none_but_reflect_configured(self, monkeypatch):
        ...
        from entelechy_api import MemoryEngine
        from entelechy_api.engine.reflect.models import ReflectAgentResult
        ...
        monkeypatch.setattr("entelechy_api.engine.memory_engine.run_reflect_agent", fake_run_reflect_agent)
...
class TestRetryAndBackoffConfiguration:
    ...
    def test_global_retry_backoff_config_defaults(self):
        ...
        from entelechy_api.config import DEFAULT_LLM_MAX_RETRIES, get_config
    ...
    def test_per_operation_retry_backoff_config_from_env(self):
        ...
        from entelechy_api.config import DEFAULT_LLM_MAX_RETRIES, clear_config_cache
        ...
        os.environ["ENTELECHY_API_RETAIN_LLM_MAX_RETRIES"] = str(retain_retries)
        os.environ["ENTELECHY_API_RETAIN_LLM_INITIAL_BACKOFF"] = "2.0"
        os.environ["ENTELECHY_API_RETAIN_LLM_MAX_BACKOFF"] = "120.0"
        os.environ["ENTELECHY_API_REFLECT_LLM_MAX_RETRIES"] = str(reflect_retries)
        os.environ["ENTELECHY_API_REFLECT_LLM_INITIAL_BACKOFF"] = "1.5"
        os.environ["ENTELECHY_API_REFLECT_LLM_MAX_BACKOFF"] = "90.0"
        ...
        try:
            ...
            # Clean up
            os.environ.pop("ENTELECHY_API_RETAIN_LLM_MAX_RETRIES", None)
            os.environ.pop("ENTELECHY_API_RETAIN_LLM_INITIAL_BACKOFF", None)
            os.environ.pop("ENTELECHY_API_RETAIN_LLM_MAX_BACKOFF", None)
            os.environ.pop("ENTELECHY_API_REFLECT_LLM_MAX_RETRIES", None)
            os.environ.pop("ENTELECHY_API_REFLECT_LLM_INITIAL_BACKOFF", None)
            os.environ.pop("ENTELECHY_API_REFLECT_LLM_MAX_BACKOFF", None)
            clear_config_cache()
    ...
    def test_per_operation_retry_backoff_fallback_to_global(self):
        ...
        from entelechy_api.config import clear_config_cache, get_config

        # Set only global values
        os.environ["ENTELECHY_API_LLM_MAX_RETRIES"] = "7"
        os.environ["ENTELECHY_API_LLM_INITIAL_BACKOFF"] = "3.0"
        os.environ["ENTELECHY_API_LLM_MAX_BACKOFF"] = "180.0"
        ...
        try:
            ...
            os.environ.pop("ENTELECHY_API_LLM_MAX_RETRIES", None)
            os.environ.pop("ENTELECHY_API_LLM_INITIAL_BACKOFF", None)
            os.environ.pop("ENTELECHY_API_LLM_MAX_BACKOFF", None)
            clear_config_cache()
