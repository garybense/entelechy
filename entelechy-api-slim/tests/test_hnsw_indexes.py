...
from entelechy_api.engine.retain.bank_utils import _BANK_INDEX_FACT_TYPES, _bank_index_name
...
async def test_retrieve_semantic_bm25_grouped_by_fact_type(memory, request_context):
    ...
    declared fact_type.
    """
    from entelechy_api.engine.search.retrieval import retrieve_semantic_bm25_combined
