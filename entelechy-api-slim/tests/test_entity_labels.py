...
from entelechy_api.engine.retain.entity_labels import (
    EntityLabelsConfig,
    LabelGroup,
    LabelValue,
    build_labels_lookup,
...
def test_build_labels_model_single_value():
    ...
    from entelechy_api.engine.retain.entity_labels import build_labels_model
...
def test_is_label_entity_enum_match():
    from entelechy_api.engine.retain.entity_labels import build_labels_lookup, is_label_entity, parse_entity_labels
...
def test_build_labels_prompt_section_none():
    from entelechy_api.engine.retain.fact_extraction import _build_labels_prompt_section
...
def test_augment_texts_with_entities():
    ...
    from entelechy_api.engine.retain.embedding_processing import augment_texts_with_dates
    from entelechy_api.engine.retain.types import ExtractedFact
...
def test_inject_label_tags_adds_tagged_entities():
    ...
    from entelechy_api.engine.retain.fact_extraction import _inject_label_tags
    from entelechy_api.engine.retain.types import ExtractedFact
...
def test_label_entity_post_processing():
    ...
    from entelechy_api.engine.retain.entity_labels import build_labels_lookup, parse_entity_labels
    from entelechy_api.engine.retain.fact_extraction import Entity
...
def _run_label_post_processing(labels_cfg, labels_data: dict) -> set[str]:
    ...
    from entelechy_api.engine.retain.entity_labels import build_labels_lookup
    from entelechy_api.engine.retain.fact_extraction import Entity
...
def test_free_values_label_accepts_any_string():
    ...
    from entelechy_api.engine.retain.entity_labels import parse_entity_labels
...
def test_free_values_label_is_single_value():
    ...
    from entelechy_api.engine.retain.entity_labels import build_labels_model, parse_entity_labels
...
def test_extraction_schema_no_labels_when_unconfigured():
    ...
    from entelechy_api.engine.retain.fact_extraction import (
