...
from entelechy_api.engine.providers.openai_compatible_llm import _strip_code_fences
...
class TestStripCodeFences:
    ...
    def test_minimax_style_response(self):
        ...
        content = (
            ...
            '  "facts": [\n'
            "    {\n"
            '      "what": "Sebastian switched the Entelechy extraction LLM",\n'
            '      "when": "2026-03-21",\n'
            '      "where": "N/A",\n'
            '      "who": "Sebastian",\n'
            ...
            '      "fact_kind": "event",\n'
            '      "fact_type": "world",\n'
            '      "entities": [{"text": "Sebastian"}, {"text": "Entelechy"}],\n'
