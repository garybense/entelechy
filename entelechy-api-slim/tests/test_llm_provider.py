"""
Test LLM provider with different models using actual Entelechy memory operations.
...
from entelechy_api.engine.utils import extract_facts
from entelechy_api.engine.search.think_utils import reflect
...
async def test_llm_provider_api_methods(provider: str, model: str):
    """
    Test all LLM API methods used by Entelechy at runtime.
...
# NOTE: The tests above validate the critical Entelechy operations:
#
...
#   - Run your local LLM server OR set ENTELECHY_API_LLM_PROVIDER/API_KEY/MODEL env vars
#
