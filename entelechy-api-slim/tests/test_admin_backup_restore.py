...
import entelechy_api.admin.cli as admin_cli
from entelechy_api.admin.cli import _backup, _restore, BACKUP_TABLES
from entelechy_api.extensions import Tenant
...
async def test_run_migration_without_schema_discovers_and_deduplicates_schemas(monkeypatch):
    ...
    monkeypatch.setenv("ENTELECHY_API_DATABASE_URL", "postgresql://test")
    ...
    from entelechy_api import migrations as migrations_module
