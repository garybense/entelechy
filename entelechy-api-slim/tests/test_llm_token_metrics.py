...
async def test_llm_metrics_recorded_for_groq():
    ...
    Uses openai/gpt-oss-20b as recommended by Entelechy.
    """
    ...
    with patch("entelechy_api.engine.providers.openai_compatible_llm.get_metrics_collector", return_value=mock_collector):
        llm = LLMProvider(
            provider="groq",
            api_key=api_key,
            base_url="",
