...
from entelechy_api.metrics import (
    MetricsCollector,
...
class TestMetricsCollector:
    ...
    def collector(self, mock_meter):
        ...
        with patch("entelechy_api.metrics.get_meter", return_value=mock_meter), \
             patch("entelechy_api.config.get_config", return_value=mock_config):
    ...
    def test_record_operation_includes_bank_id_when_enabled(self):
        ...
        with patch("entelechy_api.metrics.get_meter") as mock_get_meter, \
             patch("entelechy_api.config.get_config", return_value=mock_config):
...
class TestGetMetricsCollector:
    ...
    def test_returns_noop_by_default(self):
        ...
        # Reset global state
        import entelechy_api.metrics as metrics_module
