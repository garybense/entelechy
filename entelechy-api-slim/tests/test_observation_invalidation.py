...
class TestDocumentUpsertObservationCleanup:
    ...
    async def test_upsert_document_removes_observations_from_outgoing_memories(
        ...
        from entelechy_api.engine.retain.fact_storage import handle_document_tracking
...
class TestConsolidationSourceMemoryFiltering:
    ...
    async def test_create_observation_filters_deleted_source_memories(
        ...
        from entelechy_api.engine.consolidation.consolidator import _create_observation_directly
    ...
    async def test_update_observation_skipped_when_all_new_sources_deleted(
        ...
        from entelechy_api.engine.consolidation.consolidator import _execute_update_action
        from entelechy_api.engine.response_models import MemoryFact
