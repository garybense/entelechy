...
class TestDefaultBankTemplateEnvVar:
    """Tests for ENTELECHY_API_DEFAULT_BANK_TEMPLATE — a server-level env var
    ...
    async def test_default_template_overrides_env_config_defaults(
        ...
        We point both ENTELECHY_API_RETAIN_EXTRACTION_MODE (env) and the
    ...
    def test_parse_default_bank_template_valid_json(self, monkeypatch):
        ...
        from entelechy_api.config import _parse_default_bank_template
    ...
    def test_parse_default_bank_template_invalid_json_raises(self):
        ...
        with pytest.raises(ValueError, match="ENTELECHY_API_DEFAULT_BANK_TEMPLATE"):
