...
from entelechy_api.engine.cross_encoder import RemoteTEICrossEncoder
...
class TestRemoteTEICrossEncoderConfig:
    ...
    def test_create_from_env(self):
        ...
        from entelechy_api.engine.cross_encoder import create_cross_encoder_from_env

        with patch.dict(
            os.environ,
            {
                "ENTELECHY_API_RERANKER_PROVIDER": "tei",
                "ENTELECHY_API_RERANKER_TEI_URL": "http://test:9000",
                "ENTELECHY_API_RERANKER_TEI_BATCH_SIZE": "256",
                "ENTELECHY_API_RERANKER_TEI_MAX_CONCURRENT": "16",
            },
        ):
    ...
    def test_create_from_env_with_custom_timeout(self):
        """Test that ENTELECHY_API_RERANKER_TEI_HTTP_TIMEOUT is respected."""
        import os
        ...
        with patch.dict(
            os.environ,
            {
                "ENTELECHY_API_RERANKER_PROVIDER": "tei",
                "ENTELECHY_API_RERANKER_TEI_URL": "http://test:9000",
                "ENTELECHY_API_RERANKER_TEI_HTTP_TIMEOUT": "120.0",
            },
        ):
            clear_config_cache()
            encoder = create_cross_encoder_from_env()
