...
from entelechy_api.engine.cross_encoder import GoogleCrossEncoder, create_cross_encoder_from_env
...
class TestGoogleCrossEncoderFactory:
    ...
    def _make_config(self, **overrides) -> EntelechyConfig:
        from dataclasses import fields

        defaults = {}
        for f in fields(EntelechyConfig):
            if f.type == "str":
                defaults[f.name] = ""
        ...
        return EntelechyConfig(**defaults)
