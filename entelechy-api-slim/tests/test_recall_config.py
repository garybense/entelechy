...
from entelechy_api.engine.reflect.tools import tool_recall
from entelechy_api.engine.response_models import RecallResult as RecallResultModel
...
class TestRecallConfigFields:
    ...
    def test_env_var_constants(self):
        ...
        assert ENV_RECALL_INCLUDE_CHUNKS == "ENTELECHY_API_RECALL_INCLUDE_CHUNKS"
        assert ENV_RECALL_MAX_TOKENS == "ENTELECHY_API_RECALL_MAX_TOKENS"
        assert ENV_RECALL_CHUNKS_MAX_TOKENS == "ENTELECHY_API_RECALL_CHUNKS_MAX_TOKENS"

    @patch.dict(
        "os.environ",
        {
            "ENTELECHY_API_RECALL_INCLUDE_CHUNKS": "false",
            "ENTELECHY_API_RECALL_MAX_TOKENS": "777",
            "ENTELECHY_API_RECALL_CHUNKS_MAX_TOKENS": "333",
        },
    )
...
class TestMentalModelTriggerRecallFields:
    ...
    def test_trigger_accepts_new_fields(self):
        from entelechy_api.api.http import MentalModelTrigger
...
class TestRefreshTriggerWiring:
    ...
    async def test_trigger_overrides_passed_to_reflect_async(self, mock_request_context):
        ...
        from entelechy_api.engine.response_models import ReflectResult
