...
from entelechy_api.config import (
...
from entelechy_api.config_resolver import _validate_recall_budget_updates
from entelechy_api.engine.memory_engine import Budget, _resolve_thinking_budget
...
class TestBudgetConfigFields:
    def test_fields_exist_on_dataclass(self):
        names = {f.name for f in dataclasses.fields(EntelechyConfig)}
    ...
    def test_env_var_constants(self):
        assert ENV_RECALL_BUDGET_FUNCTION == "ENTELECHY_API_RECALL_BUDGET_FUNCTION"
        assert ENV_RECALL_BUDGET_FIXED_LOW == "ENTELECHY_API_RECALL_BUDGET_FIXED_LOW"
        assert ENV_RECALL_BUDGET_FIXED_MID == "ENTELECHY_API_RECALL_BUDGET_FIXED_MID"
        assert ENV_RECALL_BUDGET_FIXED_HIGH == "ENTELECHY_API_RECALL_BUDGET_FIXED_HIGH"
        assert ENV_RECALL_BUDGET_ADAPTIVE_LOW == "ENTELECHY_API_RECALL_BUDGET_ADAPTIVE_LOW"
        assert ENV_RECALL_BUDGET_ADAPTIVE_MID == "ENTELECHY_API_RECALL_BUDGET_ADAPTIVE_MID"
        assert ENV_RECALL_BUDGET_MIN == "ENTELECHY_API_RECALL_BUDGET_MIN"
        assert ENV_RECALL_BUDGET_MAX == "ENTELECHY_API_RECALL_BUDGET_MAX"
