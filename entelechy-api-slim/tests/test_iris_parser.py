...
Tests are skipped automatically if ENTELECHY_API_FILE_PARSER_IRIS_TOKEN
and ENTELECHY_API_FILE_PARSER_IRIS_ORG_ID are not set in the environment.
"""
...
from entelechy_api.config import ENV_FILE_PARSER_IRIS_ORG_ID, ENV_FILE_PARSER_IRIS_TOKEN
from entelechy_api.engine.parsers.iris import IrisParser
...
pytestmark = pytest.mark.skipif(
    ...
    reason="ENTELECHY_API_FILE_PARSER_IRIS_TOKEN and ENTELECHY_API_FILE_PARSER_IRIS_ORG_ID not set",
)

# Minimal valid PDF with the text "Hello from Entelechy"
...
<< /Length 44 >>
stream
BT /F1 12 Tf 100 700 Td (Hello from Entelechy) Tj ET
endstream
endobj
xref
0 5
