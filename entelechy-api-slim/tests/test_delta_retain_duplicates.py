...
async def test_repeated_upsert_chunks_not_scrambled(memory, request_context):
    ...
    try:
        ...
        from entelechy_api.engine.retain import chunk_storage, fact_extraction
...
async def test_concurrent_upserts_no_duplicates(memory_no_llm, request_context):
    ...
    try:
        ...
        from entelechy_api.engine.retain.fact_extraction import _sanitize_text
        ...
        from entelechy_api.engine.retain.fact_extraction import chunk_text
