...
from entelechy_api.engine.cross_encoder import LiteLLMSDKCrossEncoder, create_cross_encoder_from_env
...
class TestFactoryFunction:
    ...
    async def test_create_litellm_sdk_from_env(self):
        ...
        env_vars = {
            "ENTELECHY_API_RERANKER_PROVIDER": "litellm-sdk",
            "ENTELECHY_API_RERANKER_LITELLM_SDK_API_KEY": "test_key",
            "ENTELECHY_API_RERANKER_LITELLM_SDK_MODEL": "deepinfra/Qwen3-reranker-8B",
        }
        ...
        with patch.dict(os.environ, env_vars, clear=False):
            ...
            with patch("entelechy_api.config.get_config", return_value=config):
    ...
    async def test_create_litellm_sdk_missing_api_key(self):
        ...
        with patch.dict(os.environ, env_vars, clear=False):
            ...
            if "ENTELECHY_API_RERANKER_LITELLM_SDK_API_KEY" in os.environ:
                del os.environ["ENTELECHY_API_RERANKER_LITELLM_SDK_API_KEY"]
            ...
            with patch("entelechy_api.config.get_config", return_value=config):
                with pytest.raises(ValueError, match="ENTELECHY_API_RERANKER_LITELLM_SDK_API_KEY is required"):
    ...
    async def test_create_litellm_sdk_with_custom_api_base(self):
        ...
        env_vars = {
            "ENTELECHY_API_RERANKER_PROVIDER": "litellm-sdk",
            "ENTELECHY_API_RERANKER_LITELLM_SDK_API_KEY": "test_key",
            "ENTELECHY_API_RERANKER_LITELLM_SDK_MODEL": "cohere/rerank-english-v3.0",
            "ENTELECHY_API_RERANKER_LITELLM_SDK_API_BASE": "https://custom.api.example.com",
        }
