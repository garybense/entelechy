...
from entelechy_api.engine.cross_encoder import CohereCrossEncoder, create_cross_encoder_from_env
...
class TestFactoryFunction:
    ...
    async def test_create_cohere_from_env(self):
        ...
        env_vars = {
            "ENTELECHY_API_RERANKER_PROVIDER": "cohere",
            "ENTELECHY_API_RERANKER_COHERE_API_KEY": "test_key",
            "ENTELECHY_API_RERANKER_COHERE_MODEL": "rerank-english-v3.0",
        }
    ...
    async def test_create_cohere_with_azure_base_url_from_env(self):
        ...
        env_vars = {
            "ENTELECHY_API_RERANKER_PROVIDER": "cohere",
            "ENTELECHY_API_RERANKER_COHERE_API_KEY": "test_key",
            "ENTELECHY_API_RERANKER_COHERE_MODEL": "cohere-rerank-v3-english",
            "ENTELECHY_API_RERANKER_COHERE_BASE_URL": "https://my-endpoint.inference.ai.azure.com/models/cohere-rerank-v3-english/invoke",
        }
