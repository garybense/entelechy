...
from entelechy_api import MemoryEngine, RequestContext
from entelechy_api.engine.cross_encoder import (
    CohereCrossEncoder,
    LocalSTCrossEncoder,
    SiliconFlowCrossEncoder,
    ZeroEntropyCrossEncoder,
)
from entelechy_api.engine.embeddings import CohereEmbeddings, LocalSTEmbeddings, OpenAIEmbeddings
...
from entelechy_api.extensions import TenantContext, TenantExtension
from entelechy_api.migrations import ensure_embedding_dimension, run_migrations
...
def has_openai_api_key() -> bool:
    ...
    return bool(os.environ.get("ENTELECHY_API_EMBEDDINGS_OPENAI_API_KEY"))


def get_openai_api_key() -> str:
    """Get OpenAI API key from environment."""
    return os.environ.get("ENTELECHY_API_EMBEDDINGS_OPENAI_API_KEY", "")
...
def openai_embeddings():
    ...
    if not has_openai_api_key():
        pytest.skip("OpenAI API key not available (set ENTELECHY_API_EMBEDDINGS_OPENAI_API_KEY)")
