"""Tests for the Entelechy extensions system."""
...
class TestExtensionLoader:
    ...
    def test_load_extension_with_config(self, monkeypatch):
        ...
        monkeypatch.setenv(
            "ENTELECHY_API_TEST_EXTENSION",
            "tests.test_extensions:LifecycleTestExtension",
        )
        monkeypatch.setenv("ENTELECHY_API_TEST_API_URL", "https://example.com")
        monkeypatch.setenv("ENTELECHY_API_TEST_MAX_RETRIES", "5")
...
class TestTenantExtension:
    ...
    def test_api_key_tenant_extension_requires_config(self):
        ...
        assert "ENTELECHY_API_TENANT_API_KEY is required" in str(exc_info.value)
...
class TestHttpExtensionIntegration:
    ...
    def test_load_http_extension(self, monkeypatch):
        ...
        monkeypatch.setenv(
            "ENTELECHY_API_HTTP_EXTENSION",
            "tests.test_extensions:SampleHttpExtension",
        )
        monkeypatch.setenv("ENTELECHY_API_HTTP_CUSTOM_PARAM", "custom_value")
    ...
    def test_http_extension_router_mounted_at_ext(self, memory):
        ...
        from entelechy_api.api.http import create_app
