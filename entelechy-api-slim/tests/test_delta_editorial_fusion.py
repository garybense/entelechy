...
Requires: ENTELECHY_RUN_GEMINI_EVALS=1 + a Gemini/OpenAI API key.
"""
...
# Gate
# ---------------------------------------------------------------------------
_GEMINI_KEY = os.getenv("ENTELECHY_GEMINI_API_KEY") or os.getenv("GEMINI_API_KEY") or os.getenv("GOOGLE_API_KEY")
_OPENAI_KEY = os.getenv("OPENAI_API_KEY")
_RUN = os.getenv("ENTELECHY_RUN_GEMINI_EVALS") == "1" and (bool(_GEMINI_KEY) or bool(_OPENAI_KEY))
pytestmark = pytest.mark.skipif(not _RUN, reason="Set ENTELECHY_RUN_GEMINI_EVALS=1 + LLM API key")
