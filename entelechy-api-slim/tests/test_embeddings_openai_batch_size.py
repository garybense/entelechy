"""
Tests for ENTELECHY_API_EMBEDDINGS_OPENAI_BATCH_SIZE config wiring.
...
def setup_test_env():
    ...
    env_vars_to_save = [
        ...
        "ENTELECHY_API_EMBEDDINGS_OPENAI_API_KEY",
        "ENTELECHY_API_EMBEDDINGS_OPENAI_MODEL",
        "ENTELECHY_API_EMBEDDINGS_OPENAI_BATCH_SIZE",
        "ENTELECHY_API_EMBEDDINGS_OPENROUTER_API_KEY",
        "ENTELECHY_API_LLM_API_KEY",
        "ENTELECHY_API_LLM_PROVIDER",
    ]
...
def test_default_openai_batch_size_is_100():
    ...
    from entelechy_api.config import EntelechyConfig

    os.environ["ENTELECHY_API_LLM_PROVIDER"] = "mock"
    os.environ.pop("ENTELECHY_API_EMBEDDINGS_OPENAI_BATCH_SIZE", None)
...
def test_openai_batch_size_env_var_is_read():
    """ENTELECHY_API_EMBEDDINGS_OPENAI_BATCH_SIZE overrides the default."""
    from entelechy_api.config import EntelechyConfig

    os.environ["ENTELECHY_API_LLM_PROVIDER"] = "mock"
    os.environ["ENTELECHY_API_EMBEDDINGS_OPENAI_BATCH_SIZE"] = "10"
...
def test_openai_embeddings_provider_uses_configured_batch_size():
    ...
    from entelechy_api.engine.embeddings import OpenAIEmbeddings, create_embeddings_from_env

    os.environ["ENTELECHY_API_LLM_PROVIDER"] = "mock"
    os.environ["ENTELECHY_API_EMBEDDINGS_PROVIDER"] = "openai"
    os.environ["ENTELECHY_API_EMBEDDINGS_OPENAI_API_KEY"] = "sk-test"
    os.environ["ENTELECHY_API_EMBEDDINGS_OPENAI_BATCH_SIZE"] = "10"
...
def test_openrouter_provider_uses_configured_batch_size():
    ...
    os.environ["ENTELECHY_API_LLM_PROVIDER"] = "mock"
    os.environ["ENTELECHY_API_EMBEDDINGS_PROVIDER"] = "openrouter"
    os.environ["ENTELECHY_API_EMBEDDINGS_OPENROUTER_API_KEY"] = "sk-or-test"
    os.environ["ENTELECHY_API_EMBEDDINGS_OPENAI_BATCH_SIZE"] = "8"
...
def test_zero_batch_size_is_rejected():
    ...
    os.environ["ENTELECHY_API_LLM_PROVIDER"] = "mock"
    os.environ["ENTELECHY_API_EMBEDDINGS_OPENAI_BATCH_SIZE"] = "0"

    with pytest.raises(ValueError, match="must be >= 1"):
        EntelechyConfig.from_env()
...
def test_negative_batch_size_is_rejected():
    ...
    os.environ["ENTELECHY_API_LLM_PROVIDER"] = "mock"
    os.environ["ENTELECHY_API_EMBEDDINGS_OPENAI_BATCH_SIZE"] = "-5"
...
def test_non_numeric_batch_size_is_rejected():
    ...
    os.environ["ENTELECHY_API_LLM_PROVIDER"] = "mock"
    os.environ["ENTELECHY_API_EMBEDDINGS_OPENAI_BATCH_SIZE"] = "not-a-number"

    with pytest.raises(ValueError, match="ENTELECHY_API_EMBEDDINGS_OPENAI_BATCH_SIZE"):
        EntelechyConfig.from_env()
...
def test_openai_encode_splits_on_configured_batch_size(monkeypatch):
    ...
    from entelechy_api.engine.embeddings import OpenAIEmbeddings
