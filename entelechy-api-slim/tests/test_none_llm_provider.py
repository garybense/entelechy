...
Verifies that when ENTELECHY_API_LLM_PROVIDER=none:
...
from entelechy_api.api import create_app
from entelechy_api.engine.cross_encoder import LocalSTCrossEncoder
from entelechy_api.engine.memory_engine import Budget
from entelechy_api.engine.providers.none_llm import LLMNotAvailableError, NoneLLM
