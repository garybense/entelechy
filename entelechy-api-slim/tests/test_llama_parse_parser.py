...
ENTELECHY_API_FILE_PARSER_LLAMA_PARSE_API_KEY in the environment.
"""
...
from entelechy_api.config import ENV_FILE_PARSER_LLAMA_PARSE_API_KEY
from entelechy_api.engine.parsers.base import UnsupportedFileTypeError
from entelechy_api.engine.parsers.llama_parse import LlamaParseParser
...
_integration = pytest.mark.skipif(
    not _api_key,
    reason="ENTELECHY_API_FILE_PARSER_LLAMA_PARSE_API_KEY not set",
)
