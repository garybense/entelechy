"""
Banner display for Entelechy API startup.
...
def print_banner():
    """Print the Entelechy startup banner."""
    print(LOGO)
    tagline = gradient_text("Entelechy: Agent Memory That Works Like Human Memory")
    print(f"\n  {tagline}\n")
...
def print_startup_info(
    ...
    print(color_start("Starting Entelechy API..."))
    if version:
