...
# Set ENTELECHY_API_LLM_MAX_CONCURRENT=1 for local LLMs (LM Studio, Ollama)
...
class LLMProvider:
    ...
    def __init__(
        ...
        if self.provider == "vertexai":
            ...
            vertexai_project_id = config.llm_vertexai_project_id or "dummy-vertex-project"
    ...
    def with_config(self, config: Any) -> "ConfiguredLLMProvider":
        ...
        Args:
            config: Resolved ``EntelechyConfig`` for the current bank/request.
