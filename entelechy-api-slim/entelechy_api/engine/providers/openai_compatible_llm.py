...
from entelechy_api.config import DEFAULT_LLM_TIMEOUT, ENV_LLM_TIMEOUT
...
from entelechy_api.worker.stage import set_stage
    ...
    async def call(
        ...
        for attempt in range(max_retries + 1):
            ...
            try:
                ...
                # Record trace span
                from entelechy_api.tracing import _serialize_for_span, get_span_recorder
