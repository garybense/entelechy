...
async def _find_related_observations(
    ...
    if is_tracing_enabled():
        recall_span = tracer.start_span("entelechy.consolidation_recall")
        recall_span.set_attribute("entelechy.bank_id", bank_id)
        recall_span.set_attribute("entelechy.query", query[:100])  # Truncate for brevity
        recall_span.set_attribute("entelechy.fact_type", "observation")
    else:
        recall_span = None
