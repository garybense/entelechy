...
class DefaultTenantExtension(TenantExtension):
    ...
    ENTELECHY_API_DATABASE_SCHEMA (defaults to 'public').
    ...
    Configuration:
        ENTELECHY_API_DATABASE_SCHEMA=your-schema (optional, defaults to 'public')
...
class ApiKeyTenantExtension(TenantExtension):
    ...
    1. Validates the API key matches ENTELECHY_API_TENANT_API_KEY
    2. Returns the configured schema (ENTELECHY_API_DATABASE_SCHEMA, default 'public')
    ...
    Configuration:
        ...
        ENTELECHY_API_DATABASE_SCHEMA=your-schema (optional, defaults to 'public')
        ENTELECHY_API_TENANT_MCP_AUTH_DISABLED=true (optional, disable auth for MCP endpoints)
    ...
    def __init__(self, config: dict[str, str]):
        ...
        if not self.expected_api_key:
            raise ValueError("ENTELECHY_API_TENANT_API_KEY is required when using ApiKeyTenantExtension")
