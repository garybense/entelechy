...
if TYPE_CHECKING:
    from entelechy_api.engine.interface import MemoryEngineInterface
...
class ExtensionContext(ABC):
    ...
    Built-in implementation:
        entelechy_api.extensions.builtin.context.DefaultExtensionContext
...
class DefaultExtensionContext(ExtensionContext):
    ...
    async def run_migration(self, schema: str) -> None:
        ...
        from entelechy_api.migrations import (
