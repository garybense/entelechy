"""Base Extension class for all Entelechy extensions."""
...
class Extension(ABC):
    """
    Base class for all Entelechy extensions.

    Extensions are loaded via environment variables and receive configuration
    from prefixed environment variables.

    Example:
        ENTELECHY_API_MY_EXTENSION=mypackage.ext:MyExtension
        ENTELECHY_API_MY_SOME_CONFIG=value
