...
if TYPE_CHECKING:
    from entelechy_api.engine.db.base import DatabaseBackend
...
class ConfigResolver:
    ...
    def __init__(self, backend: "DatabaseBackend", tenant_extension: TenantExtension | None = None):
        ...
        self._configurable_fields = EntelechyConfig.get_configurable_fields()
        self._credential_fields = EntelechyConfig.get_credential_fields()

    async def resolve_full_config(self, bank_id: str, context: RequestContext | None = None) -> EntelechyConfig:
        """
        Resolve full EntelechyConfig for a bank with hierarchical overrides applied.
        ...
        Returns:
            Complete EntelechyConfig with hierarchical overrides applied
        """
        ...
        resolved_config = EntelechyConfig(**config_dict)
    ...
    async def update_bank_config(
        ...
        Args:
            ...
            updates: Dict of config field names to new values.
                    Keys can be in env var format (ENTELECHY_API_LLM_PROVIDER)
...
def apply_strategy(config: EntelechyConfig, strategy_name: str) -> EntelechyConfig:
    """
