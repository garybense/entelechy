"""Shared MCP tool implementations for Entelechy.
...
from entelechy_api.engine.response_models import VALID_RECALL_FACT_TYPES
...
def register_mcp_tools(
    ...
    if soul_tools & tools_to_register:
        ...
        register_soul_tools(mcp, memory, config)
