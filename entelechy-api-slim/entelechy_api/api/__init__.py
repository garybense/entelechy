"""
Unified API module for Entelechy.
...
def create_app(
    ...
    """
    Create and configure the unified Entelechy API application.
    ...
    if mcp_api_enabled:
        try:
            ...
            logger.error("Install with: pip install entelechy-api[mcp]")
            raise
    ...
    if http_api_enabled:
        ...
        app = FastAPI(title="Entelechy API", version="0.0.7")
