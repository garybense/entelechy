...
# handshake; start_here() provides structured depth on demand.
...
def _register_onboarding(mcp: "FastMCP") -> None:
    ...
    async def start_here() -> dict:
        ...
        payload identifying the system, a routing table mapping intents to
        tools, and a quickstart sequence covering first-time and returning
        agents.
        """
