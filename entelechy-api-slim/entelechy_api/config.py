"""
Centralized configuration for Entelechy API.
...
class StaticConfigProxy:
    """
    Proxy that wraps EntelechyConfig and only allows access to static (non-configurable) fields.
    ...
    def __init__(self, config: "EntelechyConfig"):
        object.__setattr__(self, "_config", config)
        object.__setattr__(self, "_configurable_fields", EntelechyConfig.get_configurable_fields())
...
def normalize_config_key(key: str) -> str:
    ...
    Examples:
        ENTELECHY_API_LLM_PROVIDER -> llm_provider
        LLM_MODEL -> llm_model
    ...
    """
    if key.startswith("ENTELECHY_API_"):
        key = key[len("ENTELECHY_API_") :]
    return key.lower()
...
def normalize_config_dict(config: dict[str, Any]) -> dict[str, Any]:
    ...
    - Env var format: {"ENTELECHY_API_LLM_PROVIDER": "openai"}
...
ENV_DATABASE_BACKEND = "ENTELECHY_API_DATABASE_BACKEND"
ENV_DATABASE_URL = "ENTELECHY_API_DATABASE_URL"
ENV_MIGRATION_DATABASE_URL = "ENTELECHY_API_MIGRATION_DATABASE_URL"
ENV_DATABASE_SCHEMA = "ENTELECHY_API_DATABASE_SCHEMA"
ENV_LLM_PROVIDER = "ENTELECHY_API_LLM_PROVIDER"
ENV_LLM_API_KEY = "ENTELECHY_API_LLM_API_KEY"
ENV_LLM_MODEL = "ENTELECHY_API_LLM_MODEL"
ENV_LLM_BASE_URL = "ENTELECHY_API_LLM_BASE_URL"
ENV_LLM_MAX_CONCURRENT = "ENTELECHY_API_LLM_MAX_CONCURRENT"
ENV_LLM_MAX_RETRIES = "ENTELECHY_API_LLM_MAX_RETRIES"
ENV_LLM_INITIAL_BACKOFF = "ENTELECHY_API_LLM_INITIAL_BACKOFF"
ENV_LLM_MAX_BACKOFF = "ENTELECHY_API_LLM_MAX_BACKOFF"
ENV_LLM_TIMEOUT = "ENTELECHY_API_LLM_TIMEOUT"
ENV_LLM_GROQ_SERVICE_TIER = "ENTELECHY_API_LLM_GROQ_SERVICE_TIER"
ENV_LLM_OPENAI_SERVICE_TIER = "ENTELECHY_API_LLM_OPENAI_SERVICE_TIER"
ENV_LLM_EXTRA_BODY = "ENTELECHY_API_LLM_EXTRA_BODY"
...
ENV_RETAIN_LLM_PROVIDER = "ENTELECHY_API_RETAIN_LLM_PROVIDER"
ENV_RETAIN_LLM_API_KEY = "ENTELECHY_API_RETAIN_LLM_API_KEY"
ENV_RETAIN_LLM_MODEL = "ENTELECHY_API_RETAIN_LLM_MODEL"
ENV_RETAIN_LLM_BASE_URL = "ENTELECHY_API_RETAIN_LLM_BASE_URL"
ENV_RETAIN_LLM_MAX_CONCURRENT = "ENTELECHY_API_RETAIN_LLM_MAX_CONCURRENT"
ENV_RETAIN_LLM_MAX_RETRIES = "ENTELECHY_API_RETAIN_LLM_MAX_RETRIES"
ENV_RETAIN_LLM_INITIAL_BACKOFF = "ENTELECHY_API_RETAIN_LLM_INITIAL_BACKOFF"
ENV_RETAIN_LLM_MAX_BACKOFF = "ENTELECHY_API_RETAIN_LLM_MAX_BACKOFF"
ENV_RETAIN_LLM_TIMEOUT = "ENTELECHY_API_RETAIN_LLM_TIMEOUT"

ENV_REFLECT_LLM_PROVIDER = "ENTELECHY_API_REFLECT_LLM_PROVIDER"
ENV_REFLECT_LLM_API_KEY = "ENTELECHY_API_REFLECT_LLM_API_KEY"
ENV_REFLECT_LLM_MODEL = "ENTELECHY_API_REFLECT_LLM_MODEL"
ENV_REFLECT_LLM_BASE_URL = "ENTELECHY_API_REFLECT_LLM_BASE_URL"
ENV_REFLECT_LLM_MAX_CONCURRENT = "ENTELECHY_API_REFLECT_LLM_MAX_CONCURRENT"
ENV_REFLECT_LLM_MAX_RETRIES = "ENTELECHY_API_REFLECT_LLM_MAX_RETRIES"
ENV_REFLECT_LLM_INITIAL_BACKOFF = "ENTELECHY_API_REFLECT_LLM_INITIAL_BACKOFF"
ENV_REFLECT_LLM_MAX_BACKOFF = "ENTELECHY_API_REFLECT_LLM_MAX_BACKOFF"
ENV_REFLECT_LLM_TIMEOUT = "ENTELECHY_API_REFLECT_LLM_TIMEOUT"

ENV_CONSOLIDATION_LLM_PROVIDER = "ENTELECHY_API_CONSOLIDATION_LLM_PROVIDER"
ENV_CONSOLIDATION_LLM_API_KEY = "ENTELECHY_API_CONSOLIDATION_LLM_API_KEY"
ENV_CONSOLIDATION_LLM_MODEL = "ENTELECHY_API_CONSOLIDATION_LLM_MODEL"
ENV_CONSOLIDATION_LLM_BASE_URL = "ENTELECHY_API_CONSOLIDATION_LLM_BASE_URL"
ENV_CONSOLIDATION_LLM_MAX_CONCURRENT = "ENTELECHY_API_CONSOLIDATION_LLM_MAX_CONCURRENT"
ENV_CONSOLIDATION_LLM_MAX_RETRIES = "ENTELECHY_API_CONSOLIDATION_LLM_MAX_RETRIES"
ENV_CONSOLIDATION_LLM_INITIAL_BACKOFF = "ENTELECHY_API_CONSOLIDATION_LLM_INITIAL_BACKOFF"
ENV_CONSOLIDATION_LLM_MAX_BACKOFF = "ENTELECHY_API_CONSOLIDATION_LLM_MAX_BACKOFF"
ENV_CONSOLIDATION_LLM_TIMEOUT = "ENTELECHY_API_CONSOLIDATION_LLM_TIMEOUT"

ENV_EMBEDDINGS_PROVIDER = "ENTELECHY_API_EMBEDDINGS_PROVIDER"
ENV_EMBEDDINGS_LOCAL_MODEL = "ENTELECHY_API_EMBEDDINGS_LOCAL_MODEL"
ENV_EMBEDDINGS_LOCAL_FORCE_CPU = "ENTELECHY_API_EMBEDDINGS_LOCAL_FORCE_CPU"
ENV_EMBEDDINGS_LOCAL_TRUST_REMOTE_CODE = "ENTELECHY_API_EMBEDDINGS_LOCAL_TRUST_REMOTE_CODE"
ENV_EMBEDDINGS_TEI_URL = "ENTELECHY_API_EMBEDDINGS_TEI_URL"
ENV_EMBEDDINGS_OPENAI_API_KEY = "ENTELECHY_API_EMBEDDINGS_OPENAI_API_KEY"
ENV_EMBEDDINGS_OPENAI_MODEL = "ENTELECHY_API_EMBEDDINGS_OPENAI_MODEL"
ENV_EMBEDDINGS_OPENAI_BASE_URL = "ENTELECHY_API_EMBEDDINGS_OPENAI_BASE_URL"
ENV_EMBEDDINGS_OPENAI_BATCH_SIZE = "ENTELECHY_API_EMBEDDINGS_OPENAI_BATCH_SIZE"

# Gemini/Vertex AI embeddings configuration
ENV_EMBEDDINGS_GEMINI_API_KEY = "ENTELECHY_API_EMBEDDINGS_GEMINI_API_KEY"
ENV_EMBEDDINGS_GEMINI_MODEL = "ENTELECHY_API_EMBEDDINGS_GEMINI_MODEL"
ENV_EMBEDDINGS_GEMINI_OUTPUT_DIMENSIONALITY = "ENTELECHY_API_EMBEDDINGS_GEMINI_OUTPUT_DIMENSIONALITY"
ENV_EMBEDDINGS_GEMINI_FORCE_IPV4 = "ENTELECHY_API_EMBEDDINGS_GEMINI_FORCE_IPV4"
ENV_EMBEDDINGS_VERTEXAI_PROJECT_ID = "ENTELECHY_API_EMBEDDINGS_VERTEXAI_PROJECT_ID"
ENV_EMBEDDINGS_VERTEXAI_REGION = "ENTELECHY_API_EMBEDDINGS_VERTEXAI_REGION"
ENV_EMBEDDINGS_VERTEXAI_SERVICE_ACCOUNT_KEY = "ENTELECHY_API_EMBEDDINGS_VERTEXAI_SERVICE_ACCOUNT_KEY"

# Cohere configuration (separate for embeddings and reranker)
ENV_EMBEDDINGS_COHERE_API_KEY = "ENTELECHY_API_EMBEDDINGS_COHERE_API_KEY"
ENV_EMBEDDINGS_COHERE_MODEL = "ENTELECHY_API_EMBEDDINGS_COHERE_MODEL"
ENV_EMBEDDINGS_COHERE_BASE_URL = "ENTELECHY_API_EMBEDDINGS_COHERE_BASE_URL"
ENV_EMBEDDINGS_COHERE_OUTPUT_DIMENSIONS = "ENTELECHY_API_EMBEDDINGS_COHERE_OUTPUT_DIMENSIONS"
ENV_RERANKER_COHERE_API_KEY = "ENTELECHY_API_RERANKER_COHERE_API_KEY"
ENV_RERANKER_COHERE_MODEL = "ENTELECHY_API_RERANKER_COHERE_MODEL"
ENV_RERANKER_COHERE_BASE_URL = "ENTELECHY_API_RERANKER_COHERE_BASE_URL"

# OpenRouter configuration (embeddings and reranker)
ENV_OPENROUTER_API_KEY = "ENTELECHY_API_OPENROUTER_API_KEY"
ENV_EMBEDDINGS_OPENROUTER_API_KEY = "ENTELECHY_API_EMBEDDINGS_OPENROUTER_API_KEY"
ENV_EMBEDDINGS_OPENROUTER_MODEL = "ENTELECHY_API_EMBEDDINGS_OPENROUTER_MODEL"
ENV_RERANKER_OPENROUTER_API_KEY = "ENTELECHY_API_RERANKER_OPENROUTER_API_KEY"
ENV_RERANKER_OPENROUTER_MODEL = "ENTELECHY_API_RERANKER_OPENROUTER_MODEL"

# Deprecated: Legacy shared Cohere API key (for backward compatibility)
ENV_COHERE_API_KEY = "ENTELECHY_API_COHERE_API_KEY"

# LiteLLM configuration (separate for embeddings and reranker)
ENV_EMBEDDINGS_LITELLM_API_BASE = "ENTELECHY_API_EMBEDDINGS_LITELLM_API_BASE"
ENV_EMBEDDINGS_LITELLM_API_KEY = "ENTELECHY_API_EMBEDDINGS_LITELLM_API_KEY"
ENV_EMBEDDINGS_LITELLM_MODEL = "ENTELECHY_API_EMBEDDINGS_LITELLM_MODEL"
ENV_RERANKER_LITELLM_API_BASE = "ENTELECHY_API_RERANKER_LITELLM_API_BASE"
ENV_RERANKER_LITELLM_API_KEY = "ENTELECHY_API_RERANKER_LITELLM_API_KEY"
ENV_RERANKER_LITELLM_MODEL = "ENTELECHY_API_RERANKER_LITELLM_MODEL"
ENV_RERANKER_LITELLM_MAX_TOKENS_PER_DOC = "ENTELECHY_API_RERANKER_LITELLM_MAX_TOKENS_PER_DOC"

# LiteLLM SDK configuration (direct API access, no proxy needed)
ENV_EMBEDDINGS_LITELLM_SDK_API_KEY = "ENTELECHY_API_EMBEDDINGS_LITELLM_SDK_API_KEY"
ENV_EMBEDDINGS_LITELLM_SDK_MODEL = "ENTELECHY_API_EMBEDDINGS_LITELLM_SDK_MODEL"
ENV_EMBEDDINGS_LITELLM_SDK_API_BASE = "ENTELECHY_API_EMBEDDINGS_LITELLM_SDK_API_BASE"
ENV_EMBEDDINGS_LITELLM_SDK_OUTPUT_DIMENSIONS = "ENTELECHY_API_EMBEDDINGS_LITELLM_SDK_OUTPUT_DIMENSIONS"
ENV_EMBEDDINGS_LITELLM_SDK_ENCODING_FORMAT = "ENTELECHY_API_EMBEDDINGS_LITELLM_SDK_ENCODING_FORMAT"
ENV_RERANKER_LITELLM_SDK_API_KEY = "ENTELECHY_API_RERANKER_LITELLM_SDK_API_KEY"
ENV_RERANKER_LITELLM_SDK_MODEL = "ENTELECHY_API_RERANKER_LITELLM_SDK_MODEL"
ENV_RERANKER_LITELLM_SDK_API_BASE = "ENTELECHY_API_RERANKER_LITELLM_SDK_API_BASE"

# Deprecated: Legacy shared LiteLLM config (for backward compatibility)
ENV_LITELLM_API_BASE = "ENTELECHY_API_LITELLM_API_BASE"
ENV_LITELLM_API_KEY = "ENTELECHY_API_LITELLM_API_KEY"

ENV_RERANKER_PROVIDER = "ENTELECHY_API_RERANKER_PROVIDER"
ENV_RERANKER_LOCAL_MODEL = "ENTELECHY_API_RERANKER_LOCAL_MODEL"
ENV_RERANKER_LOCAL_FORCE_CPU = "ENTELECHY_API_RERANKER_LOCAL_FORCE_CPU"
ENV_RERANKER_LOCAL_MAX_CONCURRENT = "ENTELECHY_API_RERANKER_LOCAL_MAX_CONCURRENT"
ENV_RERANKER_LOCAL_TRUST_REMOTE_CODE = "ENTELECHY_API_RERANKER_LOCAL_TRUST_REMOTE_CODE"
ENV_RERANKER_LOCAL_FP16 = "ENTELECHY_API_RERANKER_LOCAL_FP16"
ENV_RERANKER_LOCAL_BUCKET_BATCHING = "ENTELECHY_API_RERANKER_LOCAL_BUCKET_BATCHING"
ENV_RERANKER_LOCAL_BATCH_SIZE = "ENTELECHY_API_RERANKER_LOCAL_BATCH_SIZE"
ENV_RERANKER_TEI_URL = "ENTELECHY_API_RERANKER_TEI_URL"
ENV_RERANKER_TEI_BATCH_SIZE = "ENTELECHY_API_RERANKER_TEI_BATCH_SIZE"
ENV_RERANKER_TEI_MAX_CONCURRENT = "ENTELECHY_API_RERANKER_TEI_MAX_CONCURRENT"
ENV_RERANKER_TEI_HTTP_TIMEOUT = "ENTELECHY_API_RERANKER_TEI_HTTP_TIMEOUT"
ENV_RERANKER_MAX_CANDIDATES = "ENTELECHY_API_RERANKER_MAX_CANDIDATES"
ENV_RERANKER_FLASHRANK_MODEL = "ENTELECHY_API_RERANKER_FLASHRANK_MODEL"
ENV_RERANKER_FLASHRANK_CACHE_DIR = "ENTELECHY_API_RERANKER_FLASHRANK_CACHE_DIR"
ENV_RERANKER_FLASHRANK_CPU_MEM_ARENA = "ENTELECHY_API_RERANKER_FLASHRANK_CPU_MEM_ARENA"

# ZeroEntropy configuration (reranker only)
ENV_RERANKER_ZEROENTROPY_API_KEY = "ENTELECHY_API_RERANKER_ZEROENTROPY_API_KEY"
ENV_RERANKER_ZEROENTROPY_MODEL = "ENTELECHY_API_RERANKER_ZEROENTROPY_MODEL"
ENV_RERANKER_ZEROENTROPY_BASE_URL = "ENTELECHY_API_RERANKER_ZEROENTROPY_BASE_URL"

# SiliconFlow configuration (reranker only; Cohere-compatible /rerank endpoint)
ENV_RERANKER_SILICONFLOW_API_KEY = "ENTELECHY_API_RERANKER_SILICONFLOW_API_KEY"
ENV_RERANKER_SILICONFLOW_MODEL = "ENTELECHY_API_RERANKER_SILICONFLOW_MODEL"
ENV_RERANKER_SILICONFLOW_BASE_URL = "ENTELECHY_API_RERANKER_SILICONFLOW_BASE_URL"

# Google Discovery Engine reranker configuration
ENV_RERANKER_GOOGLE_MODEL = "ENTELECHY_API_RERANKER_GOOGLE_MODEL"
ENV_RERANKER_GOOGLE_PROJECT_ID = "ENTELECHY_API_RERANKER_GOOGLE_PROJECT_ID"
ENV_RERANKER_GOOGLE_SERVICE_ACCOUNT_KEY = "ENTELECHY_API_RERANKER_GOOGLE_SERVICE_ACCOUNT_KEY"

ENV_VECTOR_EXTENSION = "ENTELECHY_API_VECTOR_EXTENSION"
ENV_TEXT_SEARCH_EXTENSION = "ENTELECHY_API_TEXT_SEARCH_EXTENSION"

ENV_HOST = "ENTELECHY_API_HOST"
ENV_PORT = "ENTELECHY_API_PORT"
ENV_BASE_PATH = "ENTELECHY_API_BASE_PATH"
ENV_LOG_LEVEL = "ENTELECHY_API_LOG_LEVEL"
ENV_LOG_FORMAT = "ENTELECHY_API_LOG_FORMAT"
ENV_LOG_JSON_FIELDS = "ENTELECHY_API_LOG_JSON_FIELDS"
ENV_WORKERS = "ENTELECHY_API_WORKERS"
ENV_MCP_ENABLED = "ENTELECHY_API_MCP_ENABLED"
ENV_MCP_ENABLED_TOOLS = "ENTELECHY_API_MCP_ENABLED_TOOLS"
ENV_MCP_STATELESS = "ENTELECHY_API_MCP_STATELESS"
ENV_ENABLE_BANK_CONFIG_API = "ENTELECHY_API_ENABLE_BANK_CONFIG_API"
ENV_DEFAULT_BANK_TEMPLATE = "ENTELECHY_API_DEFAULT_BANK_TEMPLATE"
ENV_GRAPH_RETRIEVER = "ENTELECHY_API_GRAPH_RETRIEVER"
ENV_RECALL_MAX_CONCURRENT = "ENTELECHY_API_RECALL_MAX_CONCURRENT"
ENV_RECALL_CONNECTION_BUDGET = "ENTELECHY_API_RECALL_CONNECTION_BUDGET"
ENV_RECALL_MAX_QUERY_TOKENS = "ENTELECHY_API_RECALL_MAX_QUERY_TOKENS"
ENV_MENTAL_MODEL_REFRESH_CONCURRENCY = "ENTELECHY_API_MENTAL_MODEL_REFRESH_CONCURRENCY"
ENV_LINK_EXPANSION_PER_ENTITY_LIMIT = "ENTELECHY_API_LINK_EXPANSION_PER_ENTITY_LIMIT"
ENV_LINK_EXPANSION_TIMEOUT = "ENTELECHY_API_LINK_EXPANSION_TIMEOUT"

# OpenTelemetry tracing configuration
ENV_OTEL_TRACES_ENABLED = "ENTELECHY_API_OTEL_TRACES_ENABLED"
ENV_OTEL_EXPORTER_OTLP_ENDPOINT = "ENTELECHY_API_OTEL_EXPORTER_OTLP_ENDPOINT"
ENV_OTEL_EXPORTER_OTLP_HEADERS = "ENTELECHY_API_OTEL_EXPORTER_OTLP_HEADERS"
ENV_OTEL_SERVICE_NAME = "ENTELECHY_API_OTEL_SERVICE_NAME"
ENV_OTEL_DEPLOYMENT_ENVIRONMENT = "ENTELECHY_API_OTEL_DEPLOYMENT_ENVIRONMENT"
ENV_METRICS_INCLUDE_BANK_ID = "ENTELECHY_API_METRICS_INCLUDE_BANK_ID"

# Vertex AI configuration
ENV_LLM_VERTEXAI_PROJECT_ID = "ENTELECHY_API_LLM_VERTEXAI_PROJECT_ID"
ENV_LLM_VERTEXAI_REGION = "ENTELECHY_API_LLM_VERTEXAI_REGION"
ENV_LLM_VERTEXAI_SERVICE_ACCOUNT_KEY = "ENTELECHY_API_LLM_VERTEXAI_SERVICE_ACCOUNT_KEY"

# Gemini safety settings
ENV_LLM_GEMINI_SAFETY_SETTINGS = "ENTELECHY_API_LLM_GEMINI_SAFETY_SETTINGS"

# Retain settings
ENV_RETAIN_MAX_COMPLETION_TOKENS = "ENTELECHY_API_RETAIN_MAX_COMPLETION_TOKENS"
ENV_RETAIN_CHUNK_SIZE = "ENTELECHY_API_RETAIN_CHUNK_SIZE"
ENV_RETAIN_EXTRACT_CAUSAL_LINKS = "ENTELECHY_API_RETAIN_EXTRACT_CAUSAL_LINKS"
ENV_RETAIN_EXTRACTION_MODE = "ENTELECHY_API_RETAIN_EXTRACTION_MODE"
ENV_RETAIN_MISSION = "ENTELECHY_API_RETAIN_MISSION"
ENV_RETAIN_CUSTOM_INSTRUCTIONS = "ENTELECHY_API_RETAIN_CUSTOM_INSTRUCTIONS"
ENV_RETAIN_DEFAULT_STRATEGY = "ENTELECHY_API_RETAIN_DEFAULT_STRATEGY"
ENV_RETAIN_BATCH_TOKENS = "ENTELECHY_API_RETAIN_BATCH_TOKENS"
ENV_RETAIN_ENTITY_LOOKUP = "ENTELECHY_API_RETAIN_ENTITY_LOOKUP"
ENV_RETAIN_BATCH_ENABLED = "ENTELECHY_API_RETAIN_BATCH_ENABLED"
ENV_RETAIN_BATCH_POLL_INTERVAL_SECONDS = "ENTELECHY_API_RETAIN_BATCH_POLL_INTERVAL_SECONDS"
ENV_RETAIN_CHUNK_BATCH_SIZE = "ENTELECHY_API_RETAIN_CHUNK_BATCH_SIZE"

# File storage configuration
ENV_FILE_STORAGE_TYPE = "ENTELECHY_API_FILE_STORAGE_TYPE"
ENV_FILE_STORAGE_S3_BUCKET = "ENTELECHY_API_FILE_STORAGE_S3_BUCKET"
ENV_FILE_STORAGE_S3_REGION = "ENTELECHY_API_FILE_STORAGE_S3_REGION"
ENV_FILE_STORAGE_S3_ENDPOINT = "ENTELECHY_API_FILE_STORAGE_S3_ENDPOINT"
ENV_FILE_STORAGE_S3_ACCESS_KEY_ID = "ENTELECHY_API_FILE_STORAGE_S3_ACCESS_KEY_ID"
ENV_FILE_STORAGE_S3_SECRET_ACCESS_KEY = "ENTELECHY_API_FILE_STORAGE_S3_SECRET_ACCESS_KEY"
ENV_FILE_STORAGE_GCS_BUCKET = "ENTELECHY_API_FILE_STORAGE_GCS_BUCKET"
ENV_FILE_STORAGE_GCS_SERVICE_ACCOUNT_KEY = "ENTELECHY_API_FILE_STORAGE_GCS_SERVICE_ACCOUNT_KEY"
ENV_FILE_STORAGE_AZURE_CONTAINER = "ENTELECHY_API_FILE_STORAGE_AZURE_CONTAINER"
ENV_FILE_STORAGE_AZURE_ACCOUNT_NAME = "ENTELECHY_API_FILE_STORAGE_AZURE_ACCOUNT_NAME"
ENV_FILE_STORAGE_AZURE_ACCOUNT_KEY = "ENTELECHY_API_FILE_STORAGE_AZURE_ACCOUNT_KEY"
ENV_FILE_PARSER = "ENTELECHY_API_FILE_PARSER"
ENV_FILE_PARSER_ALLOWLIST = "ENTELECHY_API_FILE_PARSER_ALLOWLIST"
ENV_FILE_PARSER_IRIS_TOKEN = "ENTELECHY_API_FILE_PARSER_IRIS_TOKEN"
ENV_FILE_PARSER_IRIS_ORG_ID = "ENTELECHY_API_FILE_PARSER_IRIS_ORG_ID"
ENV_FILE_PARSER_LLAMA_PARSE_API_KEY = "ENTELECHY_API_FILE_PARSER_LLAMA_PARSE_API_KEY"
ENV_FILE_CONVERSION_MAX_BATCH_SIZE_MB = "ENTELECHY_API_FILE_CONVERSION_MAX_BATCH_SIZE_MB"
ENV_FILE_CONVERSION_MAX_BATCH_SIZE = "ENTELECHY_API_FILE_CONVERSION_MAX_BATCH_SIZE"
ENV_ENABLE_FILE_UPLOAD_API = "ENTELECHY_API_ENABLE_FILE_UPLOAD_API"
ENV_FILE_DELETE_AFTER_RETAIN = "ENTELECHY_API_FILE_DELETE_AFTER_RETAIN"

# Observations settings (consolidated knowledge from facts)
ENV_ENABLE_OBSERVATIONS = "ENTELECHY_API_ENABLE_OBSERVATIONS"
ENV_CONSOLIDATION_BATCH_SIZE = "ENTELECHY_API_CONSOLIDATION_BATCH_SIZE"
ENV_CONSOLIDATION_MAX_MEMORIES_PER_ROUND = "ENTELECHY_API_CONSOLIDATION_MAX_MEMORIES_PER_ROUND"
ENV_CONSOLIDATION_LLM_BATCH_SIZE = "ENTELECHY_API_CONSOLIDATION_LLM_BATCH_SIZE"
ENV_CONSOLIDATION_MAX_TOKENS = "ENTELECHY_API_CONSOLIDATION_MAX_TOKENS"
ENV_CONSOLIDATION_SOURCE_FACTS_MAX_TOKENS = "ENTELECHY_API_CONSOLIDATION_SOURCE_FACTS_MAX_TOKENS"
ENV_CONSOLIDATION_SOURCE_FACTS_MAX_TOKENS_PER_OBSERVATION = (
    "ENTELECHY_API_CONSOLIDATION_SOURCE_FACTS_MAX_TOKENS_PER_OBSERVATION"
)
ENV_CONSOLIDATION_RECALL_BUDGET = "ENTELECHY_API_CONSOLIDATION_RECALL_BUDGET"
ENV_CONSOLIDATION_MAX_ATTEMPTS = "ENTELECHY_API_CONSOLIDATION_MAX_ATTEMPTS"
ENV_OBSERVATIONS_MISSION = "ENTELECHY_API_OBSERVATIONS_MISSION"
ENV_MAX_OBSERVATIONS_PER_SCOPE = "ENTELECHY_API_MAX_OBSERVATIONS_PER_SCOPE"
ENV_ENABLE_OBSERVATION_HISTORY = "ENTELECHY_API_ENABLE_OBSERVATION_HISTORY"
ENV_ENABLE_MENTAL_MODEL_HISTORY = "ENTELECHY_API_ENABLE_MENTAL_MODEL_HISTORY"

# Webhook configuration (global, static - server-level only)
ENV_WEBHOOK_URL = "ENTELECHY_API_WEBHOOK_URL"
ENV_WEBHOOK_SECRET = "ENTELECHY_API_WEBHOOK_SECRET"
ENV_WEBHOOK_EVENT_TYPES = "ENTELECHY_API_WEBHOOK_EVENT_TYPES"
ENV_WEBHOOK_DELIVERY_POLL_INTERVAL_SECONDS = "ENTELECHY_API_WEBHOOK_DELIVERY_POLL_INTERVAL_SECONDS"

# Built-in llama.cpp configuration (for provider=llamacpp)
ENV_LLAMACPP_MODEL_PATH = "ENTELECHY_API_LLAMACPP_MODEL_PATH"
ENV_LLAMACPP_GPU_LAYERS = "ENTELECHY_API_LLAMACPP_GPU_LAYERS"
ENV_LLAMACPP_CONTEXT_SIZE = "ENTELECHY_API_LLAMACPP_CONTEXT_SIZE"
ENV_LLAMACPP_CHAT_FORMAT = "ENTELECHY_API_LLAMACPP_CHAT_FORMAT"
ENV_LLAMACPP_NO_GRAMMAR = "ENTELECHY_API_LLAMACPP_NO_GRAMMAR"
ENV_LLAMACPP_EXTRA_ARGS = "ENTELECHY_API_LLAMACPP_EXTRA_ARGS"

# Optimization flags
ENV_SKIP_LLM_VERIFICATION = "ENTELECHY_API_SKIP_LLM_VERIFICATION"
ENV_LAZY_RERANKER = "ENTELECHY_API_LAZY_RERANKER"

# Database migrations
ENV_RUN_MIGRATIONS_ON_STARTUP = "ENTELECHY_API_RUN_MIGRATIONS_ON_STARTUP"

# Database connection pool
ENV_DB_POOL_MIN_SIZE = "ENTELECHY_API_DB_POOL_MIN_SIZE"
ENV_DB_POOL_MAX_SIZE = "ENTELECHY_API_DB_POOL_MAX_SIZE"
ENV_DB_COMMAND_TIMEOUT = "ENTELECHY_API_DB_COMMAND_TIMEOUT"
ENV_DB_ACQUIRE_TIMEOUT = "ENTELECHY_API_DB_ACQUIRE_TIMEOUT"
ENV_DB_STATEMENT_TIMEOUT = "ENTELECHY_API_DB_STATEMENT_TIMEOUT"

# Worker configuration (distributed task processing)
ENV_WORKER_ENABLED = "ENTELECHY_API_WORKER_ENABLED"
ENV_WORKER_ID = "ENTELECHY_API_WORKER_ID"
ENV_WORKER_POLL_INTERVAL_MS = "ENTELECHY_API_WORKER_POLL_INTERVAL_MS"
ENV_WORKER_MAX_RETRIES = "ENTELECHY_API_WORKER_MAX_RETRIES"
ENV_WORKER_HTTP_PORT = "ENTELECHY_API_WORKER_HTTP_PORT"
ENV_WORKER_MAX_SLOTS = "ENTELECHY_API_WORKER_MAX_SLOTS"
...
WORKER_SLOT_RESERVATION_TYPES: dict[str, tuple[str, int]] = {
    "consolidation": ("ENTELECHY_API_WORKER_CONSOLIDATION_MAX_SLOTS", 2),
    "retain": ("ENTELECHY_API_WORKER_RETAIN_MAX_SLOTS", 0),
    "file_convert_retain": ("ENTELECHY_API_WORKER_FILE_CONVERT_RETAIN_MAX_SLOTS", 0),
    "refresh_mental_model": ("ENTELECHY_API_WORKER_REFRESH_MENTAL_MODEL_MAX_SLOTS", 0),
}
ENV_RETAIN_MAX_CONCURRENT = "ENTELECHY_API_RETAIN_MAX_CONCURRENT"

# Reflect agent settings
ENV_REFLECT_MAX_ITERATIONS = "ENTELECHY_API_REFLECT_MAX_ITERATIONS"
ENV_REFLECT_MAX_CONTEXT_TOKENS = "ENTELECHY_API_REFLECT_MAX_CONTEXT_TOKENS"
ENV_REFLECT_WALL_TIMEOUT = "ENTELECHY_API_REFLECT_WALL_TIMEOUT"
ENV_REFLECT_MISSION = "ENTELECHY_API_REFLECT_MISSION"
ENV_REFLECT_SOURCE_FACTS_MAX_TOKENS = "ENTELECHY_API_REFLECT_SOURCE_FACTS_MAX_TOKENS"
ENV_RECALL_INCLUDE_CHUNKS = "ENTELECHY_API_RECALL_INCLUDE_CHUNKS"
ENV_RECALL_MAX_TOKENS = "ENTELECHY_API_RECALL_MAX_TOKENS"
ENV_RECALL_CHUNKS_MAX_TOKENS = "ENTELECHY_API_RECALL_CHUNKS_MAX_TOKENS"

# Recall budget mapping (budget enum -> thinking_budget integer)
ENV_RECALL_BUDGET_FUNCTION = "ENTELECHY_API_RECALL_BUDGET_FUNCTION"
ENV_RECALL_BUDGET_FIXED_LOW = "ENTELECHY_API_RECALL_BUDGET_FIXED_LOW"
ENV_RECALL_BUDGET_FIXED_MID = "ENTELECHY_API_RECALL_BUDGET_FIXED_MID"
ENV_RECALL_BUDGET_FIXED_HIGH = "ENTELECHY_API_RECALL_BUDGET_FIXED_HIGH"
ENV_RECALL_BUDGET_ADAPTIVE_LOW = "ENTELECHY_API_RECALL_BUDGET_ADAPTIVE_LOW"
ENV_RECALL_BUDGET_ADAPTIVE_MID = "ENTELECHY_API_RECALL_BUDGET_ADAPTIVE_MID"
ENV_RECALL_BUDGET_ADAPTIVE_HIGH = "ENTELECHY_API_RECALL_BUDGET_ADAPTIVE_HIGH"
ENV_RECALL_BUDGET_MIN = "ENTELECHY_API_RECALL_BUDGET_MIN"
ENV_RECALL_BUDGET_MAX = "ENTELECHY_API_RECALL_BUDGET_MAX"

# Audit log settings
ENV_AUDIT_LOG_ENABLED = "ENTELECHY_API_AUDIT_LOG_ENABLED"
ENV_AUDIT_LOG_ACTIONS = "ENTELECHY_API_AUDIT_LOG_ACTIONS"
ENV_AUDIT_LOG_RETENTION_DAYS = "ENTELECHY_API_AUDIT_LOG_RETENTION_DAYS"

# Disposition settings
ENV_DISPOSITION_SKEPTICISM = "ENTELECHY_API_DISPOSITION_SKEPTICISM"
ENV_DISPOSITION_LITERALISM = "ENTELECHY_API_DISPOSITION_LITERALISM"
ENV_DISPOSITION_EMPATHY = "ENTELECHY_API_DISPOSITION_EMPATHY"
...
DEFAULT_OTEL_SERVICE_NAME = "entelechy-api"
...
def _parse_default_bank_template(raw: str | None) -> dict | None:
    """
    Parse ENTELECHY_API_DEFAULT_BANK_TEMPLATE as JSON.
...
class EntelechyConfig:
    """Configuration container for Entelechy API."""
    ...
    def validate(self) -> None:
        ...
        if self.llm_provider != "none" and self.retain_max_completion_tokens <= self.retain_chunk_size:
            raise ValueError(
                f"Invalid configuration: ENTELECHY_API_RETAIN_MAX_COMPLETION_TOKENS "
                f"({self.retain_max_completion_tokens}) must be greater than "
                f"ENTELECHY_API_RETAIN_CHUNK_SIZE ({self.retain_chunk_size}). "
                f"\n\nYou have two options to fix this:"
                f"\n  1. Increase ENTELECHY_API_RETAIN_MAX_COMPLETION_TOKENS to a value > {self.retain_chunk_size}"
        ...
        if self.embeddings_provider == "local" or self.reranker_provider == "local":
            try:
                ...
                logger.warning(
                    ...
                    "  1. Install local ML deps: pip install entelechy-api[local-ml]\n"
                    "  2. Use a remote provider instead:\n"
                    "     ENTELECHY_API_EMBEDDINGS_PROVIDER=openai (or gemini, tei)\n"
                    "     ENTELECHY_API_RERANKER_PROVIDER=none (or tei)",
                    " and ".join(missing),
                )
        ...
        if total_reserved > self.worker_max_slots:
            ...
            raise ValueError(
                ...
                f"Reduce reservations or increase ENTELECHY_API_WORKER_MAX_SLOTS."
            )

    @classmethod
    def from_env(cls) -> "EntelechyConfig":
        ...
        config = cls(
            ...
            port=int(os.getenv("PORT") or os.getenv(ENV_PORT, DEFAULT_PORT)),
...
_config_cache: EntelechyConfig | None = None
...
def _get_raw_config() -> EntelechyConfig:
    """
    ...
    if _config_cache is None:
        _config_cache = EntelechyConfig.from_env()
