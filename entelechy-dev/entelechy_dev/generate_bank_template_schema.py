...
entelechy-docs/static/bank-template-schema.json.
"""
...
def generate_bank_template_schema(output_path: str | None = None) -> None:
    ...
    if output_path is None:
        # Default to entelechy-docs/static/bank-template-schema.json
        root_dir = Path(__file__).parent.parent.parent
        output_path = str(root_dir / "entelechy-docs" / "static" / "bank-template-schema.json")
