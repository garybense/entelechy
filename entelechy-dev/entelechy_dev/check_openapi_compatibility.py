...
def main():
    ...
    if len(sys.argv) < 3:
        ...
        print("  git show main:entelechy-docs/static/openapi.json > /tmp/old-openapi.json")
        print("  check-openapi-compatibility /tmp/old-openapi.json entelechy-docs/static/openapi.json")
        print()
        print("  # Check against a specific commit")
        print("  git show abc123:entelechy-docs/static/openapi.json > /tmp/old-openapi.json")
        print("  check-openapi-compatibility /tmp/old-openapi.json entelechy-docs/static/openapi.json")
        sys.exit(1)
