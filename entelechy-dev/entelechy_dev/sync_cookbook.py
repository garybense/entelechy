#!/usr/bin/env python3
"""
Syncs content from the entelechy-cookbook repository.
...
Usage: sync-cookbook (after installing entelechy-dev)
...
def get_docs_dir() -> Path:
    """Find the entelechy-docs src/pages/cookbook directory relative to this script."""
    script_dir = Path(__file__).parent
    return script_dir.parent.parent / "entelechy-docs" / "src" / "pages" / "cookbook"
...
def extract_tags_from_readme(readme_path: Path) -> dict[str, str]:
    ...
    - Structured YAML: tags:\n  sdk: "entelechy-client"\n  topic: "Learning"
    - Object literal: tags: { sdk: "entelechy-client", topic: "Learning" }
...
<div style={{{{textAlign: 'center', marginBottom: '3.5rem'}}}}>
  ...
  <p style={{{{fontSize: '1.05rem', color: 'var(--ifm-color-emphasis-600)', maxWidth: 520, margin: '0 auto', lineHeight: 1.7}}}}>
    Practical examples and complete applications built with Entelechy.
  </p>
</div>
...
def main():
    """Main entry point."""
    print("Syncing entelechy-cookbook...\n")
