...
Usage: generate-llms-full (after installing entelechy-dev)

Output: entelechy-docs/static/llms-full.txt (served at /llms-full.txt)
"""
...
def get_docs_dir() -> Path:
    """Find the entelechy-docs directory relative to this script."""
    script_dir = Path(__file__).parent
    return script_dir.parent.parent / "entelechy-docs" / "docs"


def get_output_file() -> Path:
    """Get output file path."""
    script_dir = Path(__file__).parent
    return script_dir.parent.parent / "entelechy-docs" / "static" / "llms-full.txt"
...
def main():
    ...
    sections.append(f"""# Entelechy Documentation

> Agent Memory that Works Like Human Memory

This file contains the complete Entelechy documentation for LLM consumption.
Generated: {timestamp}
