...
CHANGELOG_PATH = REPO_PATH / "entelechy-docs" / "src" / "pages" / "changelog" / "index.md"
INTEGRATION_CHANGELOG_DIR = REPO_PATH / "entelechy-docs" / "src" / "pages" / "changelog" / "integrations"
...
INTEGRATIONS: dict[str, IntegrationMeta] = {
    "litellm": IntegrationMeta("entelechy-litellm", "LiteLLM"),
    ...
    "agentcore": IntegrationMeta("entelechy-agentcore", "Bedrock AgentCore"),
    "smolagents": IntegrationMeta("entelechy-smolagents", "SmolAgents"),
}
...
def analyze_commits_with_llm(
    ...
    subject = f"the {integration} integration for Entelechy" if integration else f"release {version} of Entelechy"
...
def generate_changelog_entry(
    ...
    exclude_paths = ["entelechy-integrations"]
...
def generate_integration_changelog_entry(
    ...
    display_version = version.lstrip("v")
    path_filter = f"entelechy-integrations/{integration}/"
...
For the source code, see [`entelechy-integrations/{integration}`](https://github.com/{GITHUB_REPO}/tree/main/entelechy-integrations/{integration}).
