---
name: entelechy-cloud
description: Store team knowledge, project conventions, and learnings from tasks. Use to remember what works and recall context before new tasks. Connects to Entelechy Cloud. (user)
---

# Entelechy Memory Skill (Cloud)

You have persistent memory via **Entelechy Cloud**. This memory bank is **shared with the team**, so knowledge stored here benefits everyone working on this codebase.
