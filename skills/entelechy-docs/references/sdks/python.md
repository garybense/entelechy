...
Official HTTP client for the Entelechy API. Use this when you have a Entelechy server already running — locally, in Docker, or as a managed service — and you want a typed Python client to talk to it.

If you want to **embed and run a Entelechy server in your Python process** (no external server required), see [Embedded Python (entelechy-all)](./entelechy-all.md) instead.
