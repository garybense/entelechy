...
Set `retain_mission` and `retain_extraction_mode` via the [bank config API](api/memory-banks.md#retain-configuration) or the [`ENTELECHY_API_RETAIN_MISSION`](configuration.md#retain) environment variable.
