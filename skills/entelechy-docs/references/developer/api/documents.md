...
When you retain content, Entelechy splits it into chunks before extracting facts. These chunks are stored alongside the extracted memories, preserving the original text segments.
...
entelechy memory retain my-bank "Meeting notes content..." --doc-id notes-2024-03-15

# Batch retain from files
entelechy memory retain-files my-bank docs/
```
...
```bash
# Original
entelechy memory retain my-bank "Project deadline: March 31" --doc-id project-plan

# Update
entelechy memory retain my-bank "Project deadline: April 15 (extended)" --doc-id project-plan
```
...
```python
from entelechy_client_api import ApiClient, Configuration
from entelechy_client_api.api import DocumentsApi
...
```bash
entelechy document get my-bank meeting-2024-03-15
```
...
entelechy document update-tags my-bank meeting-2024-03-15 --tags team-a --tags team-b

# Remove all tags
entelechy document update-tags my-bank meeting-2024-03-15
```
...
```bash
entelechy document delete my-bank meeting-2024-03-15
```
...
```bash
# List all documents
entelechy document list my-bank

# Filter by ID substring
entelechy document list my-bank --q report

# Filter by tags
entelechy document list my-bank --tags team-a --tags team-b
```
