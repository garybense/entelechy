...
You don't need to pre-create a bank. Entelechy will automatically create it with default settings when you first use it.
...
Only applies when `ENTELECHY_API_LLM_PROVIDER` is `gemini` or `vertexai`.
