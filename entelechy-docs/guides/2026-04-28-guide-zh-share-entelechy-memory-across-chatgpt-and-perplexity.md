...
如果您需要更深入的控制，下一层是 [保留 API](https://entelechy.vectorize.io/sdks/api/retain)、[回忆 API](https://entelechy.vectorize.io/sdks/api/recall) 和来自 [文档首页](https://entelechy.vectorize.io) 的库级别配置。共享内存在保持范围时最有用。
