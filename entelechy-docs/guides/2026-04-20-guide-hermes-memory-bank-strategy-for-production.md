...
description: "Choose the right Hermes memory bank strategy for production with Entelechy, scope banks safely, and keep recall clean across users, teams, and environments."
...
- Hermes already uses the native Entelechy provider.
