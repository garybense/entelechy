---
title: "Use Mental Model Tags in Entelechy's New List View"
authors: [benfrank241]
date: 2026-04-28T14:00:00Z
tags: [mental-models, tags, control-plane, guide]
description: "Use Entelechy mental model tags with the new List view, server-side tag suggestions, and safer filtering for refresh and reflect workflows today."
image: /img/guides/guide-use-mental-model-tags-in-entelechy-list-view.png
hide_table_of_contents: true
---

![Use Mental Model Tags in Entelechy's New List View](/img/guides/guide-use-mental-model-tags-in-entelechy-list-view.png)

If you want to **use mental model tags in Entelechy's new List view**, the important change is that the control plane now treats mental models more like real working documents. The page defaults to a split pane list, and tag suggestions now come from the actual mental model tag source instead of leaving you to remember tags by hand. Keep [the mental models API docs](https://entelechy.vectorize.io/sdks/developer/api/mental-models), [the reflect docs](https://entelechy.vectorize.io/sdks/developer/api/reflect), [the observations docs](https://entelechy.vectorize.io/sdks/developer/observations), and [the docs home](https://entelechy.vectorize.io) nearby while you tune the workflow.
...
This is the part that trips people up. A mental model tag is not just a label for browsing. As the [mental models API docs](https://entelechy.vectorize.io/sdks/developer/api/mental-models) explain, tags narrow which memories the model can read during refresh, and they also affect which mental models are visible during [reflect](https://entelechy.vectorize.io/sdks/developer/api/reflect).
...
When in doubt, step back through [the mental models API docs](https://entelechy.vectorize.io/sdks/developer/api/mental-models) and [the observations guide](https://entelechy.vectorize.io/sdks/developer/observations). Most mental model confusion is really tag scope confusion.
...
- [the mental models API docs](https://entelechy.vectorize.io/sdks/developer/api/mental-models)
- [the reflect docs](https://entelechy.vectorize.io/sdks/developer/api/reflect)
