---
title: "为实际部署调整 Entelechy 内存占用空间"
authors: [benfrank241]
date: 2026-04-28T14:00:00Z
tags: [deployment, hardware, memory, guide]
description: "使用完整和精简映像、workers、控制平面和 PostgreSQL 容量规划的新内存占用空间指导来调整 Entelechy 部署。"
...
这就是为什么文档现在将 API、worker、UI 和数据库指导分开。Entelechy 是一个产品，但不是一个内存占用空间。
