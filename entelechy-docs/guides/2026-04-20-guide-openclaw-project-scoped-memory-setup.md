...
description: "Set up OpenClaw project-scoped memory with Entelechy, keep one project’s context separate from another, and choose when to use fixed banks versus dynamic isolation."
...
- OpenClaw and the Entelechy plugin are already installed.
