...
When you call **reflect**, Entelechy performs a multi-step reasoning process:
...
```javascript
import { Entelechy } from "@anthropic-ai/entelechy";

const client = new Entelechy();
