...
| Entelechy | Returns synthesized entity observations: subscription status, billing, known issues |
...
| Entelechy | Forms opinion "user prefers sync" (0.7) → updates to "user growing comfortable with async" (0.6) |
