...
Entelechy uses PostgreSQL as its sole storage backend.
...
Entelechy does not abstract storage behind a generic interface. This is a deliberate trade-off.
...
Any PostgreSQL instance that satisfies these requirements should work. If you encounter issues with a specific setup, [open a GitHub issue](https://github.com/entelechy-ai/entelechy/issues).
