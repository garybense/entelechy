...
Official Go client for the Entelechy API, generated from the OpenAPI 3.1 spec using [OpenAPI Generator](https://github.com/OpenAPITools/openapi-generator).
...
The Go client provides access to all Entelechy API operations through structured namespaces:
...
- [OpenAPI specification](https://entelechy.dev/openapi.json) - Complete API reference
