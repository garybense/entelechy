...
if (violations.length > 0) {
  ...
  console.error('  title: "MyFramework Persistent Memory with Entelechy | Integration"');
  console.error('  description: "Add long-term memory to MyFramework agents with Entelechy. ..."');
  console.error('  ---');
  process.exit(1);
} else {
