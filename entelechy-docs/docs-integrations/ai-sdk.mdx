...
The `@garybense/entelechy-ai-sdk` package integrates [Entelechy](https://mindmods.org) memory with the [Vercel AI SDK](https://ai-sdk.dev). It provides five ready-to-use tools for retaining, recalling, and reflecting on long-term memories.
...
```bash
npm install @garybense/entelechy-ai-sdk @garybense/entelechy-client ai
```
