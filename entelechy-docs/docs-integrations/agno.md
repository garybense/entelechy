---
sidebar_position: 9
title: "Agno Agent Persistent Memory with Entelechy | Integration Guide"
description: "Add persistent memory to Agno agents using Entelechy's retain, recall, and reflect tools. Plug into Agno's native Toolkit pattern for long-term memory across sessions."
---

# Agno

Persistent memory tools for [Agno](https://github.com/agno-agi/agno) agents via Entelechy. Give your agents long-term memory with retain, recall, and reflect — using Agno's native Toolkit pattern.
