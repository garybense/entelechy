---
sidebar_position: 13
title: "Strands Agents Persistent Memory with Entelechy | Integration"
description: "Add long-term memory to Strands Agents SDK agents with Entelechy. Retain, recall, and reflect tools using Strands' native @tool pattern for persistent memory across sessions."
---

# Strands Agents

Persistent memory tools for [Strands Agents SDK](https://github.com/strands-agents/sdk-python) agents via Entelechy. Give your agents long-term memory with retain, recall, and reflect — using Strands' native `@tool` pattern.
