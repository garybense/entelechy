...
const ANNOUNCEMENT_BAR = 'Entelechy is State-of-the-Art on Memory for AI Agents | <a href="https://arxiv.org/abs/2512.12818" target="_blank">Read the paper →</a>';

const config: Config = {
  title: 'Entelechy',
  tagline: 'Entelechy: Agent Memory That Works Like Human Memory',
      ...
      items: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              href: 'https://join.slack.com/t/entelechy-space/shared_invite/zt-3nhbm4w29-LeSJ5Ixi6j8PdiYOCPlOgg',
              label: 'Community',
