#!/usr/bin/env node
/**
 * Opinions API examples for Entelechy (deprecated - kept for versioned docs).
...
const client = new EntelechyClient({ baseUrl: ENTELECHY_URL });
...
await fetch(`${ENTELECHY_URL}/v1/default/banks/skeptical-bank`, { method: 'DELETE' });
