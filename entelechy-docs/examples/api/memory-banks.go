...
func main() {
	...
	client.BanksAPI.CreateOrUpdateBank(ctx, "my-bank").
		CreateBankRequest(entelechy.CreateBankRequest{}).Execute()
	// [/docs:create-bank]
	...
	client.BanksAPI.CreateOrUpdateBank(ctx, "architect-bank").
		CreateBankRequest(entelechy.CreateBankRequest{
			ReflectMission: *entelechy.NewNullableString(entelechy.PtrString(
			...
			DispositionSkepticism: *entelechy.NewNullableInt32(entelechy.PtrInt32(4)),
			DispositionLiteralism: *entelechy.NewNullableInt32(entelechy.PtrInt32(4)),
			DispositionEmpathy:    *entelechy.NewNullableInt32(entelechy.PtrInt32(2)),
		}).Execute()
	// [/docs:bank-with-disposition]
	...
	client.BanksAPI.UpdateBankConfig(ctx, "support-bank").
		BankConfigUpdate(entelechy.BankConfigUpdate{
