...
# Chat Memory App (Entelechy Cloud)


:::info Complete Application
This is a complete, runnable application demonstrating Entelechy integration.
[**View source on GitHub →**](https://github.com/vectorize-io/entelechy-cookbook/tree/main/applications/chat-memory-cloud)
:::
...
- ☁️ **Entelechy Cloud**: Memory stored in the cloud — no Docker setup needed
...
2. **Memory Bank Creation**: First message creates a personal memory bank in Entelechy Cloud
...
Next.js API Route (/api/chat)
     ↓
Entelechy Cloud recall() → Get relevant memories
     ↓
OpenAI or Groq → Generate response with memory context
     ↓
Entelechy Cloud retain() → Store conversation
     ↓
Response to User
```
