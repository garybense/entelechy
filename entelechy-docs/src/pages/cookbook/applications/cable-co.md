...
[**View source on GitHub →**](https://github.com/vectorize-io/entelechy-cookbook/tree/main/applications/cable-co)
:::
...
│           └── memory_service.py   # Entelechy retain/recall/mental models
├── frontend/
│   ├── package.json
│   ├── vite.config.ts
│   └── src/
...
See article.md for a detailed explanation of the agent learning architecture, including how Entelechy transforms CSR feedback into observations and mental models that improve the copilot's behavior over time.
