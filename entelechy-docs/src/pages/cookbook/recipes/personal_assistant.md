...
# Personal AI Assistant with Entelechy Memory


:::tip Run this notebook
This recipe is available as an interactive Jupyter notebook.
[**Open in GitHub →**](https://github.com/vectorize-io/entelechy-cookbook/blob/main/notebooks/personal_assistant.ipynb)
:::
