...
[**Open in GitHub →**](https://github.com/vectorize-io/entelechy-cookbook/blob/main/notebooks/03-support-agent-shared-knowledge.ipynb)
:::
...
print(f"View documents: {ENTELECHY_UI_URL}/banks/product-docs?view=documents")
```
...
print(f"\nView user memory: {ENTELECHY_UI_URL}/banks/user-bob?view=documents")
```
