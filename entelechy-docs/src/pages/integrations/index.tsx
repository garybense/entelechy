...
const INTEGRATIONS_JSON_URL =
  'https://github.com/vectorize-io/entelechy/edit/main/entelechy-docs/src/data/integrations.json';
      ...
      <div className={styles.cardFooter}>
        {integration.type === 'official' ? (
          <span className={styles.byLine}>
            ...
            <span className={styles.authorName}>Entelechy Team</span>
          </span>
        ) : (
          <span className={styles.byLine}>
...
export default function IntegrationsHub(): React.ReactElement {
  ...
  return (
    <Layout title="Integrations Hub" description="Browse official and community integrations for Entelechy agent memory">

      {/* Full-width hero with its own background */}
      <div className={styles.heroSection}>
        <h1 className={styles.heroTitle}>Integrations Hub</h1>
        <p className={styles.heroSubtitle}>
          Connect Entelechy to your stack. Browse official integrations and community-built connectors.
        </p>
      ...
      <div className={styles.page}>
        ...
        <div className={styles.submitBanner}>
          <div className={styles.submitBannerContent}>
            <h2 className={styles.submitBannerTitle}>Built something with Entelechy?</h2>
