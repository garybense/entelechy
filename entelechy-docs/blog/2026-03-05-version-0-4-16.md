---
title: "What's new in Entelechy 0.4.16"
description: New features and improvements in Entelechy 0.4.16
...
Entelechy 0.4.16 introduces a webhook system for event-driven memory pipelines, improved search quality, and several reliability fixes.
...
Entelechy now supports webhooks, letting you react to memory events in real time without polling the API.
...
**`consolidation.completed`** — fired after Entelechy finishes consolidating new memories into observations.
...
Entelechy 0.4.16 is a drop-in replacement for 0.4.x with no breaking changes.
