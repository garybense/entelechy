...
tags: [entelechy, self-hosted, finance, customer-story, memory, agents, multi-user]
description: "A fintech co-founder shares how he integrated Entelechy into a financial AI system from the start, using self-hosted deployment and tag-based isolation for multi-user memory."
image: /img/blog/entelechy-financial-ai-memory.png
hide_table_of_contents: true
---

![How I Built Multi-User AI Memory into a Financial Product from Day One](/img/blog/entelechy-financial-ai-memory.png)
...
I started integrating Entelechy last December, before we had real users. Here is what I built and why.
...
I use a single Entelechy bank. Within that bank, I tag everything by type:
...
When a developer pushes code, the hook extracts relevant facts, how key functions work, what patterns we use, architectural decisions that are not obvious from the code alone, and stores them in Entelechy. The next time any developer's AI assistant recalls context, that codebase knowledge surfaces alongside their personal memories.
...
I made a deliberate decision to wire Entelechy in before we had users, and I think that was the right call.
...
I am still early in exploring what Entelechy can do, I have not touched [mental models](/developer/api/mental-models) yet, but the core pattern has been solid since December.
