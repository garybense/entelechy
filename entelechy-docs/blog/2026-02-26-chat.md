...
![`@garybense/entelechy-chat` adds persistent memory with one wrapper function](/img/blog/vercel-chat.png)

## TL;DR

- Chat bots built with Vercel's Chat SDK forget everything between messages
- `@garybense/entelechy-chat` adds persistent memory with one wrapper function
...
[`@garybense/entelechy-chat`](https://entelechy.vectorize.io/sdks/integrations/chat) adds a `withEntelechyChat()` wrapper to any Chat SDK handler. It automatically recalls relevant memories before your handler runs and retains conversations after.
...
The full working example is in the [Entelechy Cookbook](https://github.com/garybense/entelechy-cookbook/tree/main/applications/chat-sdk-multi-platform). It includes:
...
- **Clone the cookbook**: [chat-sdk-multi-platform](https://github.com/garybense/entelechy-cookbook/tree/main/applications/chat-sdk-multi-platform) has the full working example
