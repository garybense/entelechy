...
authors: [benfrank241]
date: 2026-04-16
tags: [entelechy, control-plane, memory, visualization]
description: "Constellation View and the Entity Co-occurrence Graph let you inspect the structure of a Entelechy bank as an interactive graph — debug memory quality, spot noisy hubs, and explain agent recall visually."
image: /img/blog/constellation-view.png
hide_table_of_contents: true
---

![Constellation View — interactive memory graph in the Entelechy control plane](/img/blog/constellation-view.png)
...
**Constellation View** — introduced in Entelechy 0.5.0 and extended in 0.5.2 with the **Entity Co-occurrence Graph** — gives you an interactive graph of the entities and relationships inside a bank. Instead of treating long-term memory as a hidden subsystem, you can inspect it as a living structure: what clusters together, what turns into a hub, what stays isolated, and what kinds of links are actually being formed.
...
- Constellation View gives you a graph of the memories inside a Entelechy bank
...
Constellation View renders the memory entity graph in the Entelechy Control Plane as a zoomable, pannable canvas.
...
![Entity Co-occurrence Graph in the Entelechy control plane](/img/blog/entelechy-0-5-2-entity-graph.png)

The Entity Co-occurrence Graph, added in Entelechy 0.5.2, complements Constellation View with a different lens: which entities appear together across the memories in a bank.
...
If you are showing Entelechy to an engineer, product teammate, or prospective user, memory can feel abstract. A graph makes the product legible. You can show which concepts became central, how separate conversations joined into one cluster, and why one answer was easier to retrieve than another.
...
- See what else shipped in [Entelechy 0.5.0](/blog/2026/04/07/version-0-5-0) and [0.5.2](/blog/2026/04/15/version-0-5-2)
