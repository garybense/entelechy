...
:::warning
**0.5.5 contains a regression that can cause 0 facts to be extracted during retain.** The JSON schema simplification change was reverted in [0.5.6](https://github.com/garybense/entelechy/releases/tag/v0.5.6). Please upgrade to 0.5.6.
:::
