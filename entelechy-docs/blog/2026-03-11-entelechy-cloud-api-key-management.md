---
title: "What's New in Entelechy Cloud: Programmatic API Key Management"
authors: [benfrank241]
date: 2026-03-11T12:00
tags: [entelechy-cloud, release, api]
...
Combined with [bank-scoped API keys](/blog/2026/03/09/entelechy-document-upload#what-else-is-new) (released March 9), this gives you a complete least-privilege key hierarchy: a parent key with Key Creator capability manages child keys that are each locked to specific banks.
