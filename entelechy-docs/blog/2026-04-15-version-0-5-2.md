---
title: "What's new in Entelechy 0.5.2"
description: New features and improvements in Entelechy 0.5.2
authors: [nicoloboschi]
date: 2026-04-15
hide_table_of_contents: true
---

Entelechy 0.5.2 lands a new entity co-occurrence graph in the control plane, gives operators more control over mental model refresh, exposes richer metadata on async operations, and delivers a handful of reliability fixes across retain, consolidation, and the embedded daemon.
...
- [**Identifying User-Agent**](#identifying-user-agent): All Entelechy SDK clients now send a recognizable User-Agent.
...
![Revamped bank statistics view in the Entelechy control plane](/img/blog/entelechy-0-5-2-bank-stats.png)

## Identifying User-Agent

All official Entelechy clients — Python, TypeScript, Rust/Go — now send an identifying `User-Agent` header on every HTTP request. This makes server-side logs, proxy logs, and observability dashboards much easier to read: you can tell at a glance which SDK version is driving traffic, spot outdated clients in the wild, and filter traffic by client when debugging.
