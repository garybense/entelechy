...
Entelechy can notify your application in real-time when memory events occur by sending HTTP POST requests to a URL you configure.
...
Fired after Entelechy finishes consolidating new memories into observations for a bank.
