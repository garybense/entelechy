...
response = requests.post(
    f"{ENTELECHY_URL}/v1/default/banks/my-bank/import",
    json=template,
)
...
const importResponse = await fetch(
  `${ENTELECHY_URL}/v1/default/banks/my-bank/import`,
  {
    method: 'POST',
...
const dryRunResponse = await fetch(
  `${ENTELECHY_URL}/v1/default/banks/my-bank/import?dry_run=true`,
  {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify(template),
...
response = requests.get(
    f"{ENTELECHY_URL}/v1/default/banks/my-bank/export"
)
...
const exportResponse = await fetch(
  `${ENTELECHY_URL}/v1/default/banks/my-bank/export`,
);
...
response = requests.get(
    f"{ENTELECHY_URL}/v1/default/banks/source-bank/export"
)
exported = response.json()

# Import into a new bank
response = requests.post(
    f"{ENTELECHY_URL}/v1/default/banks/new-bank/import",
    json=exported,
)
```
...
const srcResponse = await fetch(
  `${ENTELECHY_URL}/v1/default/banks/source-bank/export`,
);
const srcExported = await srcResponse.json();

// Import into a new bank
await fetch(`${ENTELECHY_URL}/v1/default/banks/new-bank/import`, {
  method: 'POST',
  headers: { 'Content-Type': 'application/json' },
...
```python
response = requests.get(
    f"{ENTELECHY_URL}/v1/bank-template-schema"
)
...
const schemaResponse = await fetch(
  `${ENTELECHY_URL}/v1/bank-template-schema`,
);
