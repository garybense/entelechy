"""
Wrapper for Entelechy client that adds API namespaces.

Provides organized access to different parts of the Entelechy API through
...
class BanksAPI:
    ...
    def __init__(self, client: Entelechy):
        self._client = client
    ...
    def list(self) -> Any:
        ...
        """
        from entelechy_client.entelechy_client import _run_async
...
class EntelechyClient(Entelechy):
    """
    Enhanced Entelechy client with organized API namespaces.

    This wrapper extends the auto-generated Entelechy client with organized
    ...
    Example:
        ...
        client = EntelechyClient(base_url="http://localhost:8888")

        # Core operations (inherited from Entelechy)
