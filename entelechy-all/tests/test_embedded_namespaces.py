...
def test_ensure_started_calls_manager(embedded_client):
    ...
    # Mock Entelechy client constructor
    with patch("entelechy.embedded.Entelechy") as mock_entelechy_class:
        mock_client = Mock()
        mock_entelechy_class.return_value = mock_client
        ...
        # Verify Entelechy client was created
        mock_entelechy_class.assert_called_once_with(base_url="http://localhost:54321")
