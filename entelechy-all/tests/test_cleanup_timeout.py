...
def test_cleanup_completes_when_lock_held():
    ...
    with patch.dict("sys.modules", {
        "entelechy_client": MagicMock(),
        "entelechy_embed": MagicMock(),
        "entelechy.api_namespaces": MagicMock(),
    }):
        from entelechy.embedded import EntelechyEmbedded

        client = EntelechyEmbedded.__new__(EntelechyEmbedded)
        client.profile = "test"
