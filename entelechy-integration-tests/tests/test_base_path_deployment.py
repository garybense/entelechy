...
This test validates that Entelechy works correctly when deployed
...
API_PATH = REPO_ROOT / "entelechy-api-slim"
COMPOSE_EXAMPLES_PATH = REPO_ROOT / "docker" / "docker-compose" / "nginx"

# Add entelechy-api to path for direct API testing
...
class APIServer:
    ...
    def __init__(self, base_path: str | None = None, port: int = 18888):
        ...
        if base_path:
            self.env["ENTELECHY_API_BASE_PATH"] = base_path
    ...
    def start(self):
        ...
        log_file = f"/tmp/entelechy-api-{self.port}.log"
...
class DockerComposeStack:
    ...
    def __init__(self, compose_file: Path, project_name: str = "entelechy-test"):
        ...
        self.env["ENTELECHY_API_LLM_PROVIDER"] = os.environ.get("ENTELECHY_API_LLM_PROVIDER", "mock")
        self.env["ENTELECHY_API_LLM_MODEL"] = os.environ.get("ENTELECHY_API_LLM_MODEL", "mock-model")
...
"""
        ...
        try:
            ...
            with DockerComposeStack(test_compose, project_name="entelechy-base-path-test"):
        ...
        async with httpx.AsyncClient(base_url=base_url, timeout=30.0) as client:
            ...
            response = await client.post(
                ...
                json={
                    "items": [
                        {
                            "content": "Entelechy supports deployment under custom base paths for reverse proxy scenarios.",
...
if __name__ == "__main__":
    ...
    print("=" * 70)
    print("Entelechy Base Path Integration Tests")
    print("=" * 70)
    print()
