...
Requires:
- ENTELECHY_API_URL environment variable (e.g., http://localhost:8888)
- A running Entelechy API server with MCP enabled
"""
...
def get_mcp_url() -> str:
    ...
    base_url = os.environ.get("ENTELECHY_API_URL", "http://localhost:8888")
